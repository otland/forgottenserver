...
local CHANNEL_MAIN_TRADE = 4

local muted = Condition(CONDITION_CHANNELMUTEDTICKS, CONDITIONID_DEFAULT)
muted:setParameter(CONDITION_PARAM_SUBID, CHANNEL_MAIN_TRADE)
...
function onSpeak(player, type, message)
	...
	if player:getCondition(CONDITION_CHANNELMUTEDTICKS, CONDITIONID_DEFAULT, CHANNEL_MAIN_TRADE) then
