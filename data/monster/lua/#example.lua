...
monster.attacks = {
	...
	},
	{
		...
		target = true,
		range = 7,
		condition = { type = CONDITION_CURSED, minDamage = 10, maxDamage = 20, duration = 5000, interval = 1000 },
	},
	{
		name = "combat",
	...
	},
	{
		...
		chance = 1000,
		range = 1,
		condition = { type = CONDITION_ENERGY, minDamage = 10, maxDamage = 20, duration = 5000, interval = 1000 },
	},
	{
		name = "drunk",
		chance = 10,
