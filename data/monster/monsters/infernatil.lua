...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -2860, effect = CONST_ME_DRAWBLOOD},
	{name ="condition", interval = 1000, chance = 7, type = CONDITION_FIRE, startDamage = 0, tick = 9000, minDamage = -800, maxDamage = -1200, range = 2, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_BLOCKHIT},
	{name ="combat", interval = 1000, chance = 7, type = COMBAT_PHYSICALDAMAGE, minDamage = -250, maxDamage = -750, radius = 6, target = false, effect = CONST_ME_EXPLOSIONHIT},
	{name ="combat", interval = 1000, chance = 50, type = COMBAT_FIREDAMAGE, minDamage = -200, maxDamage = -500, radius = 5, target = false, effect = CONST_ME_BLOCKHIT},
	{name ="firefield", interval = 1000, chance = 4, radius = 8, target = false, effect = CONST_ME_EXPLOSIONHIT},
	{name ="combat", interval = 1000, chance = 34, type = COMBAT_FIREDAMAGE, minDamage = -350, maxDamage = -850, range = 7, radius = 7, target = true, ShootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA},
	{name ="combat", interval = 1000, chance = 13, type = COMBAT_FIREDAMAGE, minDamage = -500, maxDamage = -1000, length = 8, spread = 0, effect = CONST_ME_EXPLOSIONHIT},
	{name ="combat", interval = 1000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -1500, length = 8, spread = 3, effect = CONST_ME_FIREAREA}
}
...
monster.defenses = {
	...
	{name ="speed", interval = 1000, chance = 10, speed = {min = 1800, max = 1800}, duration = 4000, effect = CONST_ME_MAGIC_RED}
}
