...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -2, maxDamage = -15, range = 7, ShootEffect = CONST_ANI_POISON},
	{name ="speed", interval = 2000, chance = 15, speed = {min = -300, max = -300}, duration = 5000, length = 3, spread = 2, effect = CONST_ME_WATERSPLASH}
}
...
monster.loot = {
	{id = 2120, chance = 4540},
	{id = "gold coin", chance = 60000, maxCount = 12},
	{id = "white mushroom", chance = 8980, maxCount = 5},
