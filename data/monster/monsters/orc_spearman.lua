...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -30, range = 7, ShootEffect = CONST_ANI_SPEAR}
}
...
monster.loot = {
	...
	{id = "studded legs", chance = 8300},
	{id = "machete", chance = 2800},
	{id = "orc leather", chance = 2000},
