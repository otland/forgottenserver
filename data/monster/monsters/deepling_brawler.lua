...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DROWNDAMAGE, minDamage = -60, maxDamage = -120, range = 7, ShootEffect = CONST_ANI_SPEAR, effect = CONST_ME_LOSEENERGY}
}
...
monster.loot = {
	{id = "gold coin", chance = 61000, maxCount = 44},
