...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -165, effect = CONST_ME_DRAWBLOOD}
}
...
monster.loot = {
	{id = "gold coin", chance = 100000, maxCount = 62},
	{id = "meat", chance = 25000, maxCount = 4},
	{id = "ham", chance = 25000, maxCount = 2},
	{id = "lion's mane", chance = 21000}
}
