...
monster.attacks = {
	...
	{name ="poisonfield", interval = 1000, chance = 50, ShootEffect = CONST_ANI_POISON},
	{name ="combat", interval = 2000, chance = 40, type = COMBAT_PHYSICALDAMAGE, minDamage = -1, maxDamage = -120, effect = CONST_ME_LOSEENERGY}
}
