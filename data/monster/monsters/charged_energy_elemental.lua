...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -168, maxDamage = -100, range = 6, radius = 4, target = true, ShootEffect = CONST_ANI_ENERGY, effect = CONST_ME_PURPLEENERGY},
	{name ="condition", interval = 1000, chance = 15, type = CONDITION_ENERGY, startDamage = 0, tick = 10000, radius = 3, target = false, effect = CONST_ME_YELLOWENERGY}
}
