...
monster.attacks = {
	...
	{name = "death blob curse",  chance = 5, interval = 2000, minDamage = 0, maxDamage = 0, range = 5, effect = 3}
}

monster.defenses = {
	defense = 15,
    armor = 15,
    {name = "combat", type = COMBAT_HEALING,  chance = 5, interval = 2000, minDamage = 20, maxDamage = 30, effect = 13}
}
