...
monster.attacks = {
	{name = "melee",  attack = 0, skill = 0, minDamage = 0, maxDamage = -30, interval = 2000, effect = 0},
...
monster.defenses = {
	defense = 15,
    armor = 15,
    {name = "combat", type = COMBAT_HEALING,  chance = 25, interval = 2000, minDamage = 30, maxDamage = 40, shootEffect = 15, effect = 13}
}
