...
monster.defenses = {
	defense = 45,
    armor = 45,
    {name = "combat", type = COMBAT_HEALING,  chance = 50, interval = 2000, minDamage = 50, maxDamage = 100, effect = 13},
	{name = "combat", type = COMBAT_HEALING,  chance = 15, interval = 2000, minDamage = 500, maxDamage = 700, effect = 13}
}
