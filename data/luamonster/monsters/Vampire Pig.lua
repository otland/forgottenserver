...
monster.attacks = {
	...
	{name = "combat", type = COMBAT_LIFEDRAIN,  chance = 10, interval = 2000, minDamage = -35, maxDamage = -55, range = 3, radius = 4, effect = 67}
}

monster.defenses = {
	defense = 35,
    armor = 30,
    {name = "outfit",  chance = 20, interval = 2000, minDamage = 0, maxDamage = 0, radius = 4, effect = 13}
}
