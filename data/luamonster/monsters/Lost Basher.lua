...
monster.attacks = {
	{name = "melee",  attack = 78, skill = 80, minDamage = 0, maxDamage = -351, interval = 2000, effect = 0},
...
monster.defenses = {
	defense = 30,
    armor = 30,
    {name = "combat", type = COMBAT_HEALING,  chance = 10, interval = 2000, minDamage = 250, maxDamage = 500, shootEffect = 27, effect = 13}
}
