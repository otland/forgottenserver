...
monster.attacks = {
	{name = "melee",  attack = 100, skill = 72, interval = 2000, effect = 0},
	{name = "invisible",  chance = 25, interval = 2000, minDamage = 0, maxDamage = 0, target = true, range = 7, radius = 1, shootEffect = 4, effect = 7},
	{name = "combat", type = COMBAT_FIREDAMAGE,  chance = 25, interval = 2000, minDamage = -120, maxDamage = -460, radius = 1, shootEffect = 4, effect = 7},
	{name = "combat", type = COMBAT_PHYSICALDAMAGE,  chance = 10, interval = 2000, minDamage = 0, maxDamage = -290, radius = 3, shootEffect = 4, effect = 4},
	{name = "combat", type = COMBAT_ENERGYDAMAGE,  chance = 30, interval = 3000, minDamage = -80, maxDamage = -345, length = 8, radius = 3, shootEffect = 4, effect = 12},
