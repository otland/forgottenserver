...
monster.attacks = {
	{name = "melee",  attack = 30, skill = 35, interval = 2000, effect = 0},
...
monster.defenses = {
	defense = 15,
    armor = 15,
    {name = "combat", type = COMBAT_HEALING,  chance = 20, interval = 1000, minDamage = 100, maxDamage = 220, radius = 2, shootEffect = 4, effect = 13}
}
