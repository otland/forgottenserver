...
monster.attacks = {
	{name = "melee",  attack = 90, skill = 70, minDamage = 0, maxDamage = -360, interval = 2000, effect = 0},
	...
	{name = "combat", type = COMBAT_MANADRAIN,  chance = 25, interval = 1000, minDamage = -100, maxDamage = -400, range = 7, shootEffect = 15, effect = 14}
}

monster.defenses = {
	defense = 20,
    armor = 25,
    {name = "combat", type = COMBAT_HEALING,  chance = 50, interval = 1000, minDamage = 409, maxDamage = 812, shootEffect = 15, effect = 13}
}
