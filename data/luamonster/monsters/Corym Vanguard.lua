...
monster.attacks = {
	{name = "melee",  attack = 56, skill = 40, minDamage = 0, maxDamage = -140, interval = 2000, effect = 0},
...
monster.defenses = {
	defense = 20,
    armor = 20,
    {name = "combat", type = COMBAT_HEALING,  chance = 10, interval = 2000, minDamage = 30, maxDamage = 60, effect = 13}
}
