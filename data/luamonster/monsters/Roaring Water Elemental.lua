...
monster.attacks = {
	{name = "melee",  attack = 90, skill = 40, minDamage = 0, maxDamage = -225, interval = 2000, effect = 0},
...
monster.defenses = {
	defense = 30,
    armor = 30,
    {name = "combat", type = COMBAT_HEALING,  chance = 15, interval = 2000, minDamage = 90, maxDamage = 150, shootEffect = 29, effect = 13}
}
