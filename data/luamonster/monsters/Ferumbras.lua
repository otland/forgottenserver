...
monster.attacks = {
	{name = "melee",  attack = 0, skill = 0, minDamage = -100, maxDamage = -350, interval = 2000, effect = 0},
	...
	{name = "combat", type = COMBAT_LIFEDRAIN,  chance = 25, interval = 2000, minDamage = -50, maxDamage = -250, length = 8, shootEffect = 4, effect = 17}
}

monster.defenses = {
	defense = 120,
    armor = 100,
    {name = "combat", type = COMBAT_HEALING,  chance = 10, interval = 2000, minDamage = 900, maxDamage = 1500, shootEffect = 4, effect = 15},
	{name = "speed",  chance = 30, interval = 3000, minDamage = 0, maxDamage = 0, duration = 7000, speedChange = 360, shootEffect = 4, effect = 13},
	{name = "invisible",  chance = 20, interval = 4000, minDamage = 0, maxDamage = 0, shootEffect = 4, effect = 13}
}
