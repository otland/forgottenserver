...
monster.attacks = {
	{name = "melee",  attack = 120, skill = 80, interval = 2000, effect = 0},
	...
	{name = "combat", type = COMBAT_MANADRAIN,  chance = 15, interval = 2000, minDamage = -60, maxDamage = -120, range = 7, radius = 2, shootEffect = 30, effect = 47}
}
