...
monster.attacks = {
	{name = "melee",  attack = 25, skill = 30, minDamage = 0, maxDamage = -50, interval = 2000, effect = 0},
...
monster.defenses = {
	defense = 15,
    armor = 15,
    {name = "combat", type = COMBAT_HEALING,  chance = 30, interval = 2000, minDamage = 200, maxDamage = 300, shootEffect = 15, effect = 13},
