...
monster.attacks = {
	{name = "melee",  attack = 130, skill = 120, interval = 2000, effect = 0},
...
monster.defenses = {
	defense = 55,
    armor = 50,
    {name = "combat", type = COMBAT_HEALING,  chance = 25, interval = 5000, minDamage = 60, maxDamage = 100, radius = 1, shootEffect = 11, effect = 13}
}
