...
monster.attacks = {
	{name = "melee",  attack = 55, skill = 70, interval = 2000, effect = 0},
...
monster.defenses = {
	defense = 22,
    armor = 16,
    {name = "combat", type = COMBAT_HEALING,  chance = 15, interval = 1000, minDamage = 50, maxDamage = 100, radius = 3, shootEffect = 2, effect = 14}
}
