...
monster.attacks = {
	{name = "melee",  attack = 65, skill = 30, minDamage = 0, maxDamage = -130, interval = 2000, effect = 0},
...
monster.defenses = {
	defense = 30,
    armor = 30,
    {name = "speed",  chance = 15, interval = 2000, minDamage = 0, maxDamage = 0, duration = 5000, speedChange = 380, shootEffect = 15, effect = 14}
}
