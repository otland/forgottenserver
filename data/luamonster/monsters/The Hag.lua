...
monster.defenses = {
	defense = 25,
    armor = 24,
    {name = "combat", type = COMBAT_HEALING,  chance = 35, interval = 2000, minDamage = 95, maxDamage = 155, effect = 13},
	{name = "invisible",  chance = 50, interval = 3000, minDamage = 0, maxDamage = 0, effect = 13}
}
