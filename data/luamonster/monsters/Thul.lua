...
monster.attacks = {
	{name = "melee",  attack = 285, skill = 85, interval = 2000, effect = 0},
	...
	{name = "speed",  chance = 18, interval = 2000, minDamage = 0, maxDamage = 0, duration = 5000, speedChange = -360, range = 7, radius = 3, shootEffect = 13, effect = 10},
	{name = "combat", type = COMBAT_ICEDAMAGE,  chance = 20, interval = 2000, minDamage = -108, maxDamage = -137, range = 7, radius = 3, shootEffect = 29, effect = 42}
}
