...
monster.attacks = {
	{name = "melee",  attack = 130, skill = 130, interval = 2000, effect = 0},
...
monster.defenses = {
	defense = 65,
    armor = 70,
    {name = "combat", type = COMBAT_HEALING,  chance = 11, interval = 1000, minDamage = 400, maxDamage = 900, radius = 7, effect = 15}
}
