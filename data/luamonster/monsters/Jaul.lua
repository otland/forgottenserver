...
monster.attacks = {
	{name = "melee",  attack = 156, skill = 32, interval = 2000, effect = 10},
	...
	{name = "combat", type = COMBAT_DEATHDAMAGE,  chance = 6, interval = 1200, minDamage = -300, maxDamage = -900, length = 8, radius = 3, shootEffect = 4, effect = 18},
	{name = "combat", type = COMBAT_FIREDAMAGE,  chance = 5, interval = 1000, minDamage = -500, maxDamage = -1000, length = 8, radius = 3, shootEffect = 4, effect = 16},
	{name = "combat", type = COMBAT_ICEDAMAGE,  chance = 5, interval = 1000, minDamage = -1000, maxDamage = -2000, length = 8, radius = 3, shootEffect = 4, effect = 42},
	{name = "combat", type = COMBAT_LIFEDRAIN,  chance = 10, interval = 4000, minDamage = -500, maxDamage = -1000, length = 8, spread = 3, radius = 3, shootEffect = 4, effect = 54},
...
monster.defenses = {
	defense = 40,
    armor = 40,
    {name = "combat", type = COMBAT_HEALING,  chance = 25, interval = 2000, minDamage = 1000, maxDamage = 2300, radius = 1, shootEffect = 4, effect = 13},
	{name = "combat", type = COMBAT_HEALING,  chance = 10, interval = 5500, minDamage = 14000, maxDamage = 21000, radius = 1, shootEffect = 4, effect = 13}
}
