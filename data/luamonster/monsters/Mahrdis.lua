...
monster.attacks = {
	...
	{name = "condition", type = CONDITION_FIRE,  chance = 13, interval = 2000, minDamage = -50, maxDamage = -500, length = 8, spread = 3, radius = 4, shootEffect = 4, effect = 6}
}

monster.defenses = {
	defense = 30,
    armor = 20,
    {name = "combat", type = COMBAT_HEALING,  chance = 20, interval = 1000, minDamage = 20, maxDamage = 800, radius = 4, shootEffect = 4, effect = 13}
}
