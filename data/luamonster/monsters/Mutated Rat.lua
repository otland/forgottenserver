...
monster.attacks = {
	{name = "melee",  attack = 45, skill = 60, minDamage = 0, maxDamage = -158, interval = 2000, effect = 0},
...
monster.defenses = {
	defense = 15,
    armor = 15,
    {name = "combat", type = COMBAT_HEALING,  chance = 5, interval = 2000, minDamage = 80, maxDamage = 95, shootEffect = 15, effect = 13}
}
