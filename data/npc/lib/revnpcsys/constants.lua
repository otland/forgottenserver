...
MESSAGE_TAGS = {
	playerName = {
		...
		func = function(params)
			return params.playerName or ""
		end,
	},
	playerLevel = {
		tag = "|PLAYERLEVEL|",
		func = function(params)
			return params.playerLevel or ""
		end,
	},
	playerLevel2 = {
		tag = "|PLAYERLEVEL2|",
		func = function(params)
			return params.playerLevel2 or ""
		end,
	},
	itemCount = {
		tag = "|ITEMCOUNT|",
		func = function(params)
			return params.amount or ""
		end,
	},
	totalCost = {
		tag = "|TOTALCOST|",
		func = function(params)
			return params.total or ""
		end,
	},
	itemName = {
		tag = "|ITEMNAME|",
		func = function(params)
			return params.itemName or ""
		end,
	},
	storageKey = {
		tag = "|STORAGEKEY|",
		func = function(params)
			return params.storage and params.storage.key or ""
		end,
	},
	storageValue = {
		tag = "|STORAGEVALUE|",
		func = function(params)
			return params.storage and params.storage.value or ""
		end,
	},
	vocationName = {
		tag = "|VOCATIONNAME|",
		func = function(params)
			return params.vocation or ""
		end,
	},
}
