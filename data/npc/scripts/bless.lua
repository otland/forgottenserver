...
local node6 = keywordHandler:addKeyword({'six bless'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you want to buy the fifth blessing for 10000 gold?'})
...
local node7 = keywordHandler:addKeyword({'seven bless'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you want to buy the fifth blessing for 10000 gold?'})
	node7:addChildKeyword({'yes'}, StdModule.bless, {npcHandler = npcHandler, bless = 7, premium = true, cost = 10000})
	node7:addChildKeyword({'no'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, reset = true, text = 'Too expensive, eh?'})

local node8 = keywordHandler:addKeyword({'eight bless'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Do you want to buy the fifth blessing for 10000 gold?'})
	node8:addChildKeyword({'yes'}, StdModule.bless, {npcHandler = npcHandler, bless = 8, premium = true, cost = 10000})
