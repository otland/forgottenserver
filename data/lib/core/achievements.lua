...
achievements = {
	...
	[16] = {
		...
		points = 6,
		secret = true,
		description = "Sculpting Brog, the raging Titan, is your secret passion. Numerous perfect little clay statues with your name on them can be found everywhere around the World.",
	},
	[17] = {
		clientId = 14,
		name = "Cold as Ice",
	...
	[39] = {
		...
		points = 3,
		secret = true,
		description = "You're one of the few citizens who Armenius chose to actually show his true face to - and he made you fight him. Either that means you're very lucky or very unlucky, but one thing's for sure - it's extremely rare.",
	},
	[40] = {
		clientId = 40,
	...
	[52] = {
		...
		points = 6,
		secret = true,
		description = "Your little statues of Godsula have become quite famous around the World and there's few people with similar skills when it comes to shaping marble.",
	},
	[53] = {
		clientId = 73,
		name = "Marblelous",
		...
		points = 3,
		secret = true,
		description = "You're an aspiring marble sculptor with promising skills - proven by the perfect little Godsula statue you shaped. One day you'll be really famous!",
	},
	[54] = {
		clientId = 31,
		name = "Marid Ally",
	...
	[251] = {
		...
		points = 2,
		secret = true,
		description = "	If it wasn't for you, several banks in the World would've gotten bankrupt by now. Keep on chasing bank robbers and no one will have to worry about the World economy!",
	},
	[252] = {
		clientId = 269,
		name = "Guard Killer",
	...
	[261] = {
		...
		grade = 1,
		points = 1,
		description = "You've stopped the bank robber and returned the bag full of gold. Good to know there are still lawful citizens like you around.",
	},
	[262] = {
		clientId = 252,
		name = "Ice Harvester",
	...
	[263] = {
		...
		points = 1,
		secret = true,
		description = "You joined the Kingsday festivities and payed the King your respects. Now, off to party!",
	},
	[264] = {
		clientId = 274,
		name = "Manic",
	...
	[344] = {
		...
		grade = 1,
		points = 1,
		description = "Adventure is your middle name. You spent much time in dangerous lands and have seen things others only dream of. You know your way around in the world - you are a seasoned adventurer now. And your journey has only just begun!",
	},
	...
	[360] = {
		...
		grade = 1,
		points = 1,
		description = "Don't let its fluffy appearance deceive you. The panda is a creature of the wild. It will take you to the most distant regions of the World, always in hopes of a little bamboo to nibble on or to check on a possible mate.",
	},
	[361] = {
		clientId = 374,
		name = "Dragon Mimicry",
	...
	[383] = {
		...
		grade = 1,
		points = 2,
		description = "Whoa, sow long! This boar is like a force of nature, breaking through the undergrowth of all the forests and all records of speed. Hang on!",
	},
	[384] = {
		clientId = 375,
	...
	[402] = {
		...
		points = 3,
		secret = true,
		description = "You wandered the world in search of the ancient dragons' hoards. You are sure, you found them all.",
	},
	...
	[419] = {
		...
		grade = 1,
		points = 1,
		description = "Old temples, a meadowy countryside and the splendour of Thais - you really know every corner of King' realm now.",
	},
	[420] = {
		clientId = 458,
	...
	[427] = {
		...
		points = 2,
		secret = true,
		description = "You asked Captain Charles to take a shortcut quite a few times. Now you are all too familiar with desert islands all over the world.",
	},
	[428] = {
		clientId = 452,
	...
	[470] = {
		...
		grade = 1,
		points = 2,
		description = "Now you are able to wander around the world wearing an angst-inducing vestment.",
	},
	[471] = {
		clientId = 503,
		name = "Monsterhunter",
	...
	[479] = {
		...
		grade = 1,
		points = 3,
		description = "f a pride of lions and a pack of hyaenas feud, it is not called a catfight but a ... whatsoever. For sure, it caused a lot of drama in the Darama Desert.",
	},
	[480] = {
		clientId = 512,
		name = "Lionheart",
	...
	[498] = {
		...
		grade = 2,
		points = 6,
		description = "Exploring the depths can be a dangerous task. Surprisingly, some crude wood planks, rusty nails and a tinged pot can offer a sufficient protection against the creatures lurking in the deep.",
	},
	[499] = {
		clientId = 495,
	...
	[501] = {
		...
		grade = 1,
		points = 1,
		description = "The glooth-driven locomotive will bring you to any party in the blink of an eye.",
	},
	...
	[507] = {
		...
		grade = 1,
		points = 3,
		description = "Step by step you discovered many of the secrets hidden in the world, thus gaining the right to wear the Discoverer outfit and hat. Made-to-measure for a brave traveller of the wilds.",
	},
	[508] = {
		clientId = 540,
	...
	[509] = {
		...
		points = 1,
		secret = true,
		description = "Congratulations to your very first achievement! ... Well, not really. But imagine, it is. Because at this point during your journey into the past, achievements have been introduced.",
	},
	...
	if not self:hasAchievement(achievement.id) then
		...
		if not hideMsg then
			self:sendTextMessage(
				...
				'Congratulations! You earned the achievement "' .. achievement.name .. '".'
			)
		end
	end
	return true
