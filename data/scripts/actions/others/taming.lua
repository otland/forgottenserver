...
local config = {
	...
	[13536] = { -- diapason
		...
		fail = {
			...
			{
				sound = "*klaaaaaang* Rrrrooooaaaarrrgh!",
				text = "The crystal wolf is startled by the wrong sound of the diapason.",
			},
		},
		success = {
			sound = "*kliiiiiiiiiiing* Aooooouuuuu!!",
			text = "The smooth sound of the diapason tamed the crystal wolf.",
		},
	},
	[13537] = { -- bag of apple slices
		...
		fail = {
			...
			{
				broke = true,
				sound = "Heeee-haaa-haaa-haaw!",
				text = "You did not manage to feed the donkey enough apple slices.",
			},
		},
	...
	[13538] = { -- bamboo leaves
		...
		fail = {
			...
			{
				broke = true,
				text = "While you were trying to soothe the panda, it ate all the remaining bamboo behind your back.",
			},
	...
	[13539] = { -- golden fir cone
		...
		fail = {
			{ run = true, sound = "*sniff*", text = "The white deer flees." },
			{
				broke = true,
				sound = "ROOOAAARR!!",
				text = "Oh no... the enraged deer angrily ripped the fir cone from your hands!",
			},
		...
		fail = {
			{
				broke = true,
				sound = "Splosh!",
				text = "It looks like most of the special oil this can was holding was spilt without any effect.",
			},
		},
		success = {
			sound = "Vroooomratatatatatatat.",
			text = "The strange wheel seems to vibrate and slowly starts turning continuously.",
		},
	},
	[13939] = { -- sugar oat
		name = "wild horse",
		...
		fail = {
			{ run = true, text = "With its last strength the horse the horse runs to safety." },
			{
				broke = true,
				sound = "Weeeheeeehee",
				text = "The wild horse happily munches the sugar oat and runs on.",
			},
		...
		fail = {
			{
				run = true,
				sound = "Charrrrrr",
				text = "The magma crawler refused to drink wine and vanishes into thin air.",
			},
...
function taming.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if target:getName():lower() == "horse" and item.itemid == 13939 then
		player:say(
			"The horse happily munches the sugar oat and runs on. You shouldn't steal one of the horse station's horses anyway.",
