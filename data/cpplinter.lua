...
RETURNVALUE_CREATURENOTMOVEABLE = 74
...
PlayerFlag_CanTalkRedChannelAnonymous = 1 * 2 ^ 32
...
configKeys = {
    ...
    EXP_FROM_PLAYERS_LEVEL_RANGE = 28,
    MAX_PACKETS_PER_SECOND = 29,
    SERVER_SAVE_NOTIFY_DURATION = 30,
    YELL_MINIMUM_LEVEL = 31,
    MINIMUM_LEVEL_TO_SEND_PRIVATE = 32,
    VIP_FREE_LIMIT = 33,
    VIP_PREMIUM_LIMIT = 34,
    DEPOT_FREE_LIMIT = 35,
    DEPOT_PREMIUM_LIMIT = 36,
    STAMINA_REGEN_MINUTE = 37,
    STAMINA_REGEN_PREMIUM = 38,
    HEALTH_GAIN_COLOUR = 39,
    MANA_GAIN_COLOUR = 40,
    MANA_LOSS_COLOUR = 41
}
