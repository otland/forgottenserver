local mtype = Game.createMonsterType("red draco whelp")
local monster = {}
monster.description = "a red draco whelp"
...
monster.loot = {
    {id = 18419 --[[Tharian gem]], maxCount = 13, chance = 25000}
}

monster.attacks = {
	{name = "",  chance = 100, interval = 1000, minDamage = 0, maxDamage = -15, range = 1},
	{name = "",  chance = 10, interval = 1000, minDamage = -1, maxDamage = -10, range = 0},
	{name = "",  chance = 15, interval = 1000, minDamage = -1, maxDamage = -10, range = 7}
}
