function onSay(cid, words, param)
	...
	if not creature then
		player:sendTextMessage(MESSAGE_STATUS_SMALL, "A creature with that name could not be found.")
		return false
	end
	...
	if newPosition.x == 0 then
		player:sendTextMessage(MESSAGE_STATUS_SMALL, "You can not teleport " .. creature:getName() .. ".")
		return false
