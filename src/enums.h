...
enum ClientElement {
	...
	CLIENT_ELEMENTAL_ENERGY = 3,
	CLIENT_ELEMENTAL_ICE = 4,
	CLIENT_ELEMENTAL_HOLY = 5,
	CLIENT_ELEMENTAL_DEATH = 6,
	CLIENT_ELEMENTAL_HEALING = 7,
	CLIENT_ELEMENTAL_DROWN = 8,
	CLIENT_ELEMENTAL_LIFEDRAIN = 9,
