...
enum ConditionParam_t {
	...
	CONDITION_PARAM_CUSTOMSKILL_COOLDOWNREDUCTION = 56,
	CONDITION_PARAM_CUSTOMSKILL_INCREASEDAMAGE = 57,
	CONDITION_PARAM_CUSTOMSKILL_INCREASEHEALING = 58,
	CONDITION_PARAM_CUSTOMSKILL_INCREADEMANARESTORING = 59,
};
...
enum CustomSkills_t : uint8_t {
	CUSTOMSKILL_COOLDOWNREDUCTION = 0,
	CUSTOMSKILL_INCREASEDAMAGE = 1,
	CUSTOMSKILL_INCREASEHEALING = 2,
	CUSTOMSKILL_INCREADEMANARESTORING = 3,

	CUSTOMSKILL_FIRST = CUSTOMSKILL_COOLDOWNREDUCTION,
	CUSTOMSKILL_LAST = CUSTOMSKILL_INCREADEMANARESTORING,
	CUSTOMSKILL_SIZE = CUSTOMSKILL_LAST + 1
};
