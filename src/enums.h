...
enum BlessingType : uint8_t
{
	BLESSING_ADVENTURERS_BLESSING = 0,
	BLESSING_TWIST_OF_FATE = 1,
	BLESSING_WISDOM_OF_SOLITUDE = 2,
	BLESSING_SPARK_OF_THE_PHOENIX = 3,
	BLESSING_FIRE_OF_THE_SUNS = 4,
	BLESSING_SPIRITUAL_SHIELDING = 5,
	BLESSING_EMBRACE_OF_THE_WORLD = 6,
	BLESSING_HEART_OF_THE_MOUNTAIN = 7,
	BLESSING_BLOOD_OF_THE_MOUNTAIN = 8,

	BLESSING_FIRST = BLESSING_ADVENTURERS_BLESSING,
	BLESSING_LAST = BLESSING_BLOOD_OF_THE_MOUNTAIN
};
