...
enum itemAbilityTypes : uint64_t {
	ITEM_ABILITY_NONE,
	ITEM_ABILITY_HEALTHGAIN = 1 << 0, // DONE
	ITEM_ABILITY_HEALTHTICKS = 1 << 1, // DONE
	ITEM_ABILITY_MANAGAIN = 1 << 2, // DONE
	ITEM_ABILITY_MANATICKS = 1 << 3, // DONE
	ITEM_ABILITY_CONDITIONIMMUNITIES = 1 << 4,
	ITEM_ABILITY_CONDITIONSUPPRESSIONS = 1 << 5, // DONE
	ITEM_ABILITY_MAXHITPOINTS = 1 << 6,
	ITEM_ABILITY_MAXMANAPOINTS = 1 << 7,
	ITEM_ABILITY_MAGICPOINTS = 1 << 8,
	ITEM_ABILITY_MAXHITPOINTSPERCENT = 1 << 9,
	ITEM_ABILITY_MAXMANAPOINTSPERCENT = 1 << 10,
	ITEM_ABILITY_MAGICPOINTSPERCENT = 1 << 11,
	ITEM_ABILITY_SKILLFIST = 1 << 12,
	ITEM_ABILITY_SKILLCLUB = 1 << 13,
	ITEM_ABILITY_SKILLSWORD = 1 << 14,
	ITEM_ABILITY_SKILLAXE = 1 << 15,
	ITEM_ABILITY_SKILLDISTANCE = 1 << 16,
	ITEM_ABILITY_SKILLSHIELD = 1 << 17,
	ITEM_ABILITY_SKILLFISHING = 1 << 18,
	ITEM_ABILITY_CRITICALHITCHANCE = 1 << 19,
	ITEM_ABILITY_CRITICALHITAMOUNT = 1 << 20,
	ITEM_ABILITY_LIFELEECHCHANCE = 1 << 21,
	ITEM_ABILITY_LIFELEECHAMOUNT = 1 << 22,
	ITEM_ABILITY_MANALEECHCHANCE = 1 << 23,
	ITEM_ABILITY_MANALEECHAMOUNT = 1 << 24,
	ITEM_ABILITY_SPEED = 1 << 25, // DONE, WORKING
	ITEM_ABILITY_ABSORBPHYSICAL = 1 << 26, // DONE
	ITEM_ABILITY_ABSORBENERGY = 1 << 27, // DONE
	ITEM_ABILITY_ABSORBEARTH = 1 << 28, // DONE
	ITEM_ABILITY_ABSORBFIRE = 1 << 29, // DONE
	ITEM_ABILITY_ABSORBWATER = 1 << 30, // DONE
	ITEM_ABILITY_ABSORBICE = 1ULL << 31, // DONE
	ITEM_ABILITY_ABSORBHOLY = 1ULL << 32, // DONE
	ITEM_ABILITY_ABSORBDEATH = 1ULL << 33, // DONE
	ITEM_ABILITY_FIELDABSORBPHYSICAL = 1ULL << 34, // DONE
	ITEM_ABILITY_FIELDABSORBENERGY = 1ULL << 35, // DONE
	ITEM_ABILITY_FIELDABSORBEARTH = 1ULL << 36, // DONE
	ITEM_ABILITY_FIELDABSORBFIRE = 1ULL << 37, // DONE
	ITEM_ABILITY_FIELDABSORBWATER = 1ULL << 38, // DONE
	ITEM_ABILITY_FIELDABSORBICE = 1ULL << 39, // DONE
	ITEM_ABILITY_FIELDABSORBHOLY = 1ULL << 40, // DONE
	ITEM_ABILITY_FIELDABSORBDEATH = 1ULL << 41, // DONE
	ITEM_ABILITY_ELEMENTTYPE = 1ULL << 42, // DONE, WORKING
	ITEM_ABILITY_ELEMENTDAMAGE = 1ULL << 43, // DONE, WORKING
	ITEM_ABILITY_MANASHIELD = 1ULL << 44, // DONE, WORKING
	ITEM_ABILITY_INVISIBLE = 1ULL << 45, // DONE
	ITEM_ABILITY_REGENERATION = 1ULL << 46 // DONE
};
