...
enum StoreOfferType_t : uint8_t {
	...
	STORE_OFFERTYPE_PREMIUM = 1,
	STORE_OFFERTYPE_NAMECHANGE = 2,
	STORE_OFFERTYPE_SEXCHANGE = 3,
	STORE_OFFERTYPE_ITEM = 4,
	STORE_OFFERTYPE_STACKABLE = 5,
	STORE_OFFERTYPE_OUTFITS = 6,
	STORE_OFFERTYPE_MOUNTS = 7,
};
