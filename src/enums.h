...
enum itemAbilityTypes : uint64_t {
	...
	ITEM_ABILITY_ELEMENTTYPE = 1ULL << 43, // DONE, WORKING
	ITEM_ABILITY_ELEMENTDAMAGE = 1ULL << 44, // DONE, WORKING
	ITEM_ABILITY_MANASHIELD = 1ULL << 45, // DONE, WORKING
	ITEM_ABILITY_INVISIBLE = 1ULL << 46, // DONE
	ITEM_ABILITY_REGENERATION = 1ULL << 47 // DONE
};
