...
public:
	...
	void setCondition(const Condition* condition) { params.conditionList.emplace_front(condition); }
...
public:
	...
	MagicField* getMagicField() final { return this; }
	const MagicField* getMagicField() const final { return this; }
