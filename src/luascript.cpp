...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(LOGIN_SERVER_ERROR);
	registerEnum(LOGIN_SERVER_ERROR_NEW);
	registerEnum(LOGIN_SERVER_TOKEN_SUCCESS);
	registerEnum(LOGIN_SERVER_TOKEN_ERROR);
	registerEnum(LOGIN_SERVER_UPDATE);
	registerEnum(LOGIN_SERVER_MOTD);
	registerEnum(LOGIN_SERVER_UPDATE_NEEDED);
	registerEnum(LOGIN_SERVER_SESSION_KEY);
	registerEnum(LOGIN_SERVER_CHARACTER_LIST);
	registerEnum(LOGIN_SERVER_EXTENDED_CHARACTER_LIST);

	// Item Opcodes
	registerEnum(STATIC_TEXT);
	registerEnum(UNKNOWN_CREATURE);
	registerEnum(OUTDATED_CREATURE);
	registerEnum(CREATURE);

	// Game Server Opcodes
	registerEnum(GAME_SERVER_LOGIN_OR_PENDING_STATE);
	registerEnum(GAME_SERVER_GM_ACTIONS);
	registerEnum(GAME_SERVER_ENTER_GAME);
	registerEnum(GAME_SERVER_UPDATE_NEEDED);
	registerEnum(GAME_SERVER_LOGIN_ERROR);
	registerEnum(GAME_SERVER_LOGIN_ADVICE);
	registerEnum(GAME_SERVER_LOGIN_WAIT);
	registerEnum(GAME_SERVER_LOGIN_SUCCESS);
	registerEnum(GAME_SERVER_SESSION_END);
	registerEnum(GAME_SERVER_STORE_BUTTON_INDICATORS);
	registerEnum(GAME_SERVER_BUG_REPORT);
	registerEnum(GAME_SERVER_PING_BACK);
	registerEnum(GAME_SERVER_PING);
	registerEnum(GAME_SERVER_CHALLENGE);
	registerEnum(GAME_SERVER_DEATH);
	registerEnum(GAME_SERVER_SUPPLY_STASH);
	registerEnum(GAME_SERVER_SPECIAL_CONTAINER);
	registerEnum(GAME_SERVER_PARTY_ANALYZER);
	registerEnum(GAME_SERVER_FIRST_GAME_OPCODE);
	registerEnum(GAME_SERVER_EXTENDED_OPCODE);
	registerEnum(GAME_SERVER_CHANGE_MAP_AWARE_RANGE);
	registerEnum(GAME_SERVER_ATTCHED_EFFECT);
	registerEnum(GAME_SERVER_DETACH_EFFECT);
	registerEnum(GAME_SERVER_CREATURE_SHADER);
	registerEnum(GAME_SERVER_MAP_SHADER);
	registerEnum(GAME_SERVER_FLOOR_DESCRIPTION);
	registerEnum(GAME_SERVER_PASSIVE_COOLDOWN);
	registerEnum(GAME_SERVER_BOSSTIARY_DATA);
	registerEnum(GAME_SERVER_BOSSTIARY_SLOTS);
	registerEnum(GAME_SERVER_SEND_CLIENT_CHECK);
	registerEnum(GAME_SERVER_FULL_MAP);
	registerEnum(GAME_SERVER_MAP_TOP_ROW);
	registerEnum(GAME_SERVER_MAP_RIGHT_ROW);
	registerEnum(GAME_SERVER_MAP_BOTTOM_ROW);
	registerEnum(GAME_SERVER_MAP_LEFT_ROW);
	registerEnum(GAME_SERVER_UPDATE_TILE);
	registerEnum(GAME_SERVER_CREATE_ON_MAP);
	registerEnum(GAME_SERVER_CHANGE_ON_MAP);
	registerEnum(GAME_SERVER_DELETE_ON_MAP);
	registerEnum(GAME_SERVER_MOVE_CREATURE);
	registerEnum(GAME_SERVER_OPEN_CONTAINER);
	registerEnum(GAME_SERVER_CLOSE_CONTAINER);
	registerEnum(GAME_SERVER_CREATE_CONTAINER);
	registerEnum(GAME_SERVER_CHANGE_IN_CONTAINER);
	registerEnum(GAME_SERVER_DELETE_IN_CONTAINER);
	registerEnum(GAME_SERVER_SET_INVENTORY);
	registerEnum(GAME_SERVER_DELETE_INVENTORY);
	registerEnum(GAME_SERVER_OPEN_NPC_TRADE);
	registerEnum(GAME_SERVER_PLAYER_GOODS);
	registerEnum(GAME_SERVER_CLOSE_NPC_TRADE);
	registerEnum(GAME_SERVER_OWN_TRADE);
	registerEnum(GAME_SERVER_COUNTER_TRADE);
	registerEnum(GAME_SERVER_CLOSE_TRADE);
	registerEnum(GAME_SERVER_AMBIENT);
	registerEnum(GAME_SERVER_GRAPHICAL_EFFECT);
	registerEnum(GAME_SERVER_TEXT_EFFECT);
	registerEnum(GAME_SERVER_MISSLE_EFFECT);
	registerEnum(GAME_SERVER_ITEM_CLASSES);
	registerEnum(GAME_SERVER_TRAPPERS);
	registerEnum(GAME_SERVER_CREATURE_HEALTH);
	registerEnum(GAME_SERVER_CREATURE_LIGHT);
	registerEnum(GAME_SERVER_CREATURE_OUTFIT);
	registerEnum(GAME_SERVER_CREATURE_SPEED);
	registerEnum(GAME_SERVER_CREATURE_SKULL);
	registerEnum(GAME_SERVER_CREATURE_PARTY);
	registerEnum(GAME_SERVER_CREATURE_UNPASS);
	registerEnum(GAME_SERVER_CREATURE_MARKS);
	registerEnum(GAME_SERVER_PLAYER_HELPERS);
	registerEnum(GAME_SERVER_CREATURE_TYPE);
	registerEnum(GAME_SERVER_EDIT_TEXT);
	registerEnum(GAME_SERVER_EDIT_LIST);
	registerEnum(GAME_SERVER_SEND_GAME_NEWS);
	registerEnum(GAME_SERVER_SEND_BLESS_DIALOG);
	registerEnum(GAME_SERVER_BLESSINGS);
	registerEnum(GAME_SERVER_PRESET);
	registerEnum(GAME_SERVER_PREMIUM_TRIGGER);
	registerEnum(GAME_SERVER_PLAYER_DATA_BASIC);
	registerEnum(GAME_SERVER_PLAYER_DATA);
	registerEnum(GAME_SERVER_PLAYER_SKILLS);
	registerEnum(GAME_SERVER_PLAYER_STATE);
	registerEnum(GAME_SERVER_CLEAR_TARGET);
	registerEnum(GAME_SERVER_SPELL_DELAY);
	registerEnum(GAME_SERVER_SPELL_GROUP_DELAY);
	registerEnum(GAME_SERVER_MULTI_USE_DELAY);
	registerEnum(GAME_SERVER_PLAYER_MODES);
	registerEnum(GAME_SERVER_SET_STORE_DEEP_LINK);
	registerEnum(GAME_SERVER_SEND_RESTING_AREA_STATE);
	registerEnum(GAME_SERVER_TALK);
	registerEnum(GAME_SERVER_CHANNELS);
	registerEnum(GAME_SERVER_OPEN_CHANNEL);
	registerEnum(GAME_SERVER_OPEN_PRIVATE_CHANNEL);
	registerEnum(GAME_SERVER_RULE_VIOLATION_CHANNEL);
	registerEnum(GAME_SERVER_RULE_VIOLATION_REMOVE);
	registerEnum(GAME_SERVER_EXPERIENCE_TRACKER);
	registerEnum(GAME_SERVER_RULE_VIOLATION_CANCEL);
	registerEnum(GAME_SERVER_RULE_VIOLATION_LOCK);
	registerEnum(GAME_SERVER_OPEN_OWN_CHANNEL);
	registerEnum(GAME_SERVER_CLOSE_CHANNEL);
	registerEnum(GAME_SERVER_TEXT_MESSAGE);
	registerEnum(GAME_SERVER_CANCEL_WALK);
	registerEnum(GAME_SERVER_WALK_WAIT);
	registerEnum(GAME_SERVER_UNJUSTIFIED_STATS);
	registerEnum(GAME_SERVER_PVP_SITUATIONS);
	registerEnum(GAME_SERVER_REFRESH_BESTIARY_TRACKER);
	registerEnum(GAME_SERVER_TASK_HUNTING_BASIC_DATA);
	registerEnum(GAME_SERVER_TASK_HUNTING_DATA);
	registerEnum(GAME_SERVER_BOSSTIARY_COOLDOWN_TIMER);
	registerEnum(GAME_SERVER_FLOOR_CHANGE_UP);
	registerEnum(GAME_SERVER_FLOOR_CHANGE_DOWN);
	registerEnum(GAME_SERVER_LOOT_CONTAINERS);
	registerEnum(GAME_SERVER_CHOOSE_OUTFIT);
	registerEnum(GAME_SERVER_SEND_UPDATE_IMPACT_TRACKER);
	registerEnum(GAME_SERVER_SEND_ITEMS_PRICE);
	registerEnum(GAME_SERVER_SEND_UPDATE_SUPPLY_TRACKER);
	registerEnum(GAME_SERVER_SEND_UPDATE_LOOT_TRACKER);
	registerEnum(GAME_SERVER_KILL_TRACKER);
	registerEnum(GAME_SERVER_VIP_ADD);
	registerEnum(GAME_SERVER_VIP_STATE);
	registerEnum(GAME_SERVER_VIP_LOGOUT);
	registerEnum(GAME_SERVER_SEND_BESTIARY_ENTRY_CHANGED);
	registerEnum(GAME_SERVER_TUTORIAL_HINT);
	registerEnum(GAME_SERVER_AUTOMAP_FLAG);
	registerEnum(GAME_SERVER_SEND_DAILY_REWARD_COLLECTION_STATE);
	registerEnum(GAME_SERVER_COIN_BALANCE);
	registerEnum(GAME_SERVER_STORE_ERROR);
	registerEnum(GAME_SERVER_REQUEST_PURCHASE_DATA);
	registerEnum(GAME_SERVER_SEND_OPEN_REWARD_WALL);
	registerEnum(GAME_SERVER_SEND_DAILY_REWARD);
	registerEnum(GAME_SERVER_SEND_REWARD_HISTORY);
	registerEnum(GAME_SERVER_SEND_PREY_FREE_REROLLS);
	registerEnum(GAME_SERVER_SEND_BOSSTIARY_ENTRY_CHANGED);
	registerEnum(GAME_SERVER_SEND_PREY_TIME_LEFT);
	registerEnum(GAME_SERVER_SEND_PREY_DATA);
	registerEnum(GAME_SERVER_SEND_PREY_REROLL_PRICE);
	registerEnum(GAME_SERVER_SEND_SHOW_DESCRIPTION);
	registerEnum(GAME_SERVER_SEND_IMBUEMENT_WINDOW);
	registerEnum(GAME_SERVER_SEND_CLOSE_IMBUEMENT_WINDOW);
	registerEnum(GAME_SERVER_SEND_ERROR);
	registerEnum(GAME_SERVER_RESOURCE_BALANCE);
	registerEnum(GAME_SERVER_WORLD_TIME);
	registerEnum(GAME_SERVER_QUEST_LOG);
	registerEnum(GAME_SERVER_QUEST_LINE);
	registerEnum(GAME_SERVER_COIN_BALANCE_UPDATING);
	registerEnum(GAME_SERVER_CHANNEL_EVENT);
	registerEnum(GAME_SERVER_ITEM_INFO);
	registerEnum(GAME_SERVER_PLAYER_INVENTORY);
	registerEnum(GAME_SERVER_MARKET_ENTER);
	registerEnum(GAME_SERVER_MARKET_LEAVE);
	registerEnum(GAME_SERVER_MARKET_DETAIL);
	registerEnum(GAME_SERVER_MARKET_BROWSE);
	registerEnum(GAME_SERVER_MODAL_DIALOG);
	registerEnum(GAME_SERVER_STORE);
	registerEnum(GAME_SERVER_STORE_OFFERS);
	registerEnum(GAME_SERVER_STORE_TRANSACTION_HISTORY);
	registerEnum(GAME_SERVER_STORE_COMPLETE_PURCHASE);

	// Client Opcodes
	registerEnum(CLIENT_ENTER_ACCOUNT);
	registerEnum(CLIENT_PENDING_GAME);
	registerEnum(CLIENT_ENTER_GAME);
	registerEnum(CLIENT_LEAVE_GAME);
	registerEnum(CLIENT_PING);
	registerEnum(CLIENT_PING_BACK);
	registerEnum(CLIENT_STASH_WITHDRAW);
	registerEnum(CLIENT_RETRIEVE_DEPOT_SEARCH);
	registerEnum(CLIENT_CYCLOPEDIA_MONSTER_TRACKER);
	registerEnum(CLIENT_PARTY_ANALYZER_ACTION);
	registerEnum(CLIENT_LEADER_FINDER_WINDOW);
	registerEnum(CLIENT_MEMBER_FINDER_WINDOW);
	registerEnum(CLIENT_FIRST_GAME_OPCODE);
	registerEnum(CLIENT_EXTENDED_OPCODE);
	registerEnum(CLIENT_CHANGE_MAP_AWARE_RANGE);
	registerEnum(CLIENT_AUTO_WALK);
	registerEnum(CLIENT_WALK_NORTH);
	registerEnum(CLIENT_WALK_EAST);
	registerEnum(CLIENT_WALK_SOUTH);
	registerEnum(CLIENT_WALK_WEST);
	registerEnum(CLIENT_STOP);
	registerEnum(CLIENT_WALK_NORTH_EAST);
	registerEnum(CLIENT_WALK_SOUTH_EAST);
	registerEnum(CLIENT_WALK_SOUTH_WEST);
	registerEnum(CLIENT_WALK_NORTH_WEST);
	registerEnum(CLIENT_TURN_NORTH);
	registerEnum(CLIENT_TURN_EAST);
	registerEnum(CLIENT_TURN_SOUTH);
	registerEnum(CLIENT_TURN_WEST);
	registerEnum(CLIENT_MAP_CLICK);
	registerEnum(CLIENT_EQUIP_ITEM);
	registerEnum(CLIENT_MOVE);
	registerEnum(CLIENT_INSPECT_NPC_TRADE);
	registerEnum(CLIENT_BUY_ITEM);
	registerEnum(CLIENT_SELL_ITEM);
	registerEnum(CLIENT_CLOSE_NPC_TRADE);
	registerEnum(CLIENT_REQUEST_TRADE);
	registerEnum(CLIENT_INSPECT_TRADE);
	registerEnum(CLIENT_ACCEPT_TRADE);
	registerEnum(CLIENT_REJECT_TRADE);
	registerEnum(CLIENT_USE_ITEM);
	registerEnum(CLIENT_USE_ITEM_WITH);
	registerEnum(CLIENT_USE_ON_CREATURE);
	registerEnum(CLIENT_ROTATE_ITEM);
	registerEnum(CLIENT_EDIT_PODIUM);
	registerEnum(CLIENT_CLOSE_CONTAINER);
	registerEnum(CLIENT_UP_CONTAINER);
	registerEnum(CLIENT_EDIT_TEXT);
	registerEnum(CLIENT_EDIT_LIST);
	registerEnum(CLIENT_ON_WRAP_ITEM);
	registerEnum(CLIENT_LOOK);
	registerEnum(CLIENT_LOOK_CREATURE);
	registerEnum(CLIENT_JOIN_AGGRESSION);
	registerEnum(CLIENT_QUICK_LOOT);
	registerEnum(CLIENT_LOOT_CONTAINER);
	registerEnum(CLIENT_UPDATE_LOOT_WHITELIST);
	registerEnum(CLIENT_REQUEST_LOCKER_ITEMS);
	registerEnum(CLIENT_TALK);
	registerEnum(CLIENT_REQUEST_CHANNELS);
	registerEnum(CLIENT_JOIN_CHANNEL);
	registerEnum(CLIENT_LEAVE_CHANNEL);
	registerEnum(CLIENT_OPEN_PRIVATE_CHANNEL);
	registerEnum(CLIENT_OPEN_RULE_VIOLATION);
	registerEnum(CLIENT_CLOSE_RULE_VIOLATION);
	registerEnum(CLIENT_CANCEL_RULE_VIOLATION);
	registerEnum(CLIENT_CLOSE_NPC_CHANNEL);
	registerEnum(CLIENT_CHANGE_FIGHT_MODES);
	registerEnum(CLIENT_ATTACK);
	registerEnum(CLIENT_FOLLOW);
	registerEnum(CLIENT_INVITE_TO_PARTY);
	registerEnum(CLIENT_JOIN_PARTY);
	registerEnum(CLIENT_REVOKE_INVITATION);
	registerEnum(CLIENT_PASS_LEADERSHIP);
	registerEnum(CLIENT_LEAVE_PARTY);
	registerEnum(CLIENT_SHARE_EXPERIENCE);
	registerEnum(CLIENT_DISBAND_PARTY);
	registerEnum(CLIENT_OPEN_OWN_CHANNEL);
	registerEnum(CLIENT_INVITE_TO_OWN_CHANNEL);
	registerEnum(CLIENT_EXCLUDE_FROM_OWN_CHANNEL);
	registerEnum(CLIENT_REQUEST_HIGHSCORES);
	registerEnum(CLIENT_CANCEL_ATTACK_AND_FOLLOW);
	registerEnum(CLIENT_REQUEST_TOURNAMENT_LEADERBOARD);
	registerEnum(CLIENT_UPDATE_TILE);
	registerEnum(CLIENT_REFRESH_CONTAINER);
	registerEnum(CLIENT_BROWSE_FIELD);
	registerEnum(CLIENT_SEEK_IN_CONTAINER);
	registerEnum(CLIENT_REQUEST_INSPECT_WINDOW);
	registerEnum(CLIENT_REQUEST_QUEST_TRACKER);
	registerEnum(CLIENT_REQUEST_OUTFIT);
	registerEnum(CLIENT_CHANGE_OUTFIT);
	registerEnum(CLIENT_MOUNT);
	registerEnum(CLIENT_APPLY_IMBUEMENT);
	registerEnum(CLIENT_CLEAR_IMBUEMENT);
	registerEnum(CLIENT_CLOSE_IMBUING_WINDOW);
	registerEnum(CLIENT_ADD_VIP);
	registerEnum(CLIENT_REMOVE_VIP);
	registerEnum(CLIENT_EDIT_VIP);
	registerEnum(CLIENT_PREMIUM_SHOP_UNKNOWN_1);
	registerEnum(CLIENT_PREMIUM_SHOP_UNKNOWN_2);
	registerEnum(CLIENT_REQUEST_BESTIARY_CLASSES);
	registerEnum(CLIENT_REQUEST_BESTIARY_MONSTERS);
	registerEnum(CLIENT_REQUEST_BESTIARY_INFO);
	registerEnum(CLIENT_BUY_CHARM_RUNE);
	registerEnum(CLIENT_REQUEST_CYCLOPEDIA_CHARACTER_INFO);
	registerEnum(CLIENT_BUG_REPORT);
	registerEnum(CLIENT_RULE_VIOLATION);
	registerEnum(CLIENT_DEBUG_REPORT);
	registerEnum(CLIENT_PREY_ACTION);
	registerEnum(CLIENT_PREY_REQUEST);
	registerEnum(CLIENT_GREET);
	registerEnum(CLIENT_REQUEST_TRANSFER_COINS);
	registerEnum(CLIENT_REQUEST_QUEST_LOG);
	registerEnum(CLIENT_REQUEST_QUEST_LINE);
	registerEnum(CLIENT_NEW_RULE_VIOLATION);
	registerEnum(CLIENT_REQUEST_ITEM_INFO);
	registerEnum(CLIENT_MARKET_LEAVE);
	registerEnum(CLIENT_MARKET_BROWSE);
	registerEnum(CLIENT_MARKET_CREATE);
	registerEnum(CLIENT_MARKET_CANCEL);
	registerEnum(CLIENT_MARKET_ACCEPT);
	registerEnum(CLIENT_ANSWER_MODAL_DIALOG);
	registerEnum(CLIENT_OPEN_STORE);
	registerEnum(CLIENT_REQUEST_STORE_OFFERS);
	registerEnum(CLIENT_BUY_STORE_OFFER);
	registerEnum(CLIENT_OPEN_TRANSACTION_HISTORY);
	registerEnum(CLIENT_REQUEST_TRANSACTION_HISTORY);
