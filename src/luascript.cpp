...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(HIGHSCORES_CATEGORY_LEVEL);
	registerEnum(HIGHSCORES_CATEGORY_MAGLEVEL);
	registerEnum(HIGHSCORES_CATEGORY_FIST_FIGHTING);
	registerEnum(HIGHSCORES_CATEGORY_AXE_FIGHTING);
	registerEnum(HIGHSCORES_CATEGORY_CLUB_FIGHTING);
	registerEnum(HIGHSCORES_CATEGORY_SWORD_FIGHTING);
	registerEnum(HIGHSCORES_CATEGORY_DISTANCE_FIGHTING);
	registerEnum(HIGHSCORES_CATEGORY_SHIELDING);
	registerEnum(HIGHSCORES_CATEGORY_FISHING);
	registerEnum(HIGHSCORES_CATEGORY_ACHIEVEMENTS);
	registerEnum(HIGHSCORES_CATEGORY_LOYALTY);
	// registerEnum(HIGHSCORES_CATEGORY_DEATHS);
