...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(CONDITION_PARAM_DAMAGE_FORMULA);

	registerEnum(CONDITION_DAMAGE_FORMULA_CONSTANT);
	registerEnum(CONDITION_DAMAGE_FORMULA_LOG);
	registerEnum(CONDITION_DAMAGE_FORMULA_GROWTH);
