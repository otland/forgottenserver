...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(OWN);
	registerEnum(OTHERS);
	registerEnum(CREATURES);

	// Sounds
	registerEnum(SILENCE);
	registerEnum(HUMAN_CLOSE_ATK_FIST);
	registerEnum(MONSTER_CLOSE_ATK_FIST);
	registerEnum(MELEE_ATK_SWORD);
	registerEnum(MELEE_ATK_CLUB);
	registerEnum(MELEE_ATK_AXE);
	registerEnum(DIST_ATK_BOW);
	registerEnum(DIST_ATK_CROSSBOW);
	registerEnum(DIST_ATK_THROW);
	registerEnum(MAGICAL_RANGE_ATK);
	registerEnum(SPELL_OR_RUNE);
	registerEnum(OTHER);
	registerEnum(PHYSICAL_RANGE_MISS);
	registerEnum(DIST_ATK_BOW_SHOT);
	registerEnum(DIST_ATK_CROSSBOW_SHOT);
	registerEnum(DIST_ATK_THROW_SHOT);
	registerEnum(DIST_ATK_ROD_SHOT);
	registerEnum(DIST_ATK_WAND_SHOT);
	registerEnum(BURST_ARROW_EFFECT);
	registerEnum(DIAMOND_ARROW_EFFECT);
	registerEnum(NO_DAMAGE);
	registerEnum(MONSTER_MELEE_ATK_FIST);
	registerEnum(MONSTER_MELEE_ATK_CLAW);
	registerEnum(MONSTER_MELEE_ATK_BITE);
	registerEnum(MONSTER_MELEE_ATK_RIP);
	registerEnum(MONSTER_MELEE_ATK_ACID);
	registerEnum(MONSTER_MELEE_ATK_MAGIC);
	registerEnum(MONSTER_MELEE_ATK_ETHEREAL);
	registerEnum(MONSTER_MELEE_ATK_CONSTRUCT);
	registerEnum(SPELL_LIGHT_HEALING);
	registerEnum(SPELL_INTENSE_HEALING);
	registerEnum(SPELL_ULTIMATE_HEALING);
	registerEnum(SPELL_INTENSE_HEALING_RUNE);
	registerEnum(SPELL_ULTIMATE_HEALING_RUNE);
	registerEnum(SPELL_HASTE);
	registerEnum(SPELL_LIGHT_MAGIC_MISSILE_RUNE);
	registerEnum(SPELL_HEAVY_MAGIC_MISSILE_RUNE);
	registerEnum(SPELL_SUMMON_CREATURE);
	registerEnum(SPELL_LIGHT);
	registerEnum(SPELL_GREAT_LIGHT);
	registerEnum(SPELL_CONVINCE_CREATURE_RUNE);
	registerEnum(SPELL_ENERGY_WAVE);
	registerEnum(SPELL_CHAMELEON_RUNE);
	registerEnum(SPELL_FIREBALL_RUNE);
	registerEnum(SPELL_GREAT_FIREBALL_RUNE);
	registerEnum(SPELL_FIRE_BOMB_RUNE);
	registerEnum(SPELL_EXPLOSION_RUNE);
	registerEnum(SPELL_FIRE_WAVE);
	registerEnum(SPELL_FIND_PERSON);
	registerEnum(SPELL_SUDDENDEATH_RUNE);
	registerEnum(SPELL_ENERGY_BEAM);
	registerEnum(SPELL_GREAT_ENERGY_BEAM);
	registerEnum(SPELL_HELL_SCORE);
	registerEnum(SPELL_FIRE_FIELD_RUNE);
	registerEnum(SPELL_POISON_FIELD_RUNE);
	registerEnum(SPELL_ENERGY_FIELD_RUNE);
	registerEnum(SPELL_FIRE_WALL_RUNE);
	registerEnum(SPELL_CURE_POISON);
	registerEnum(SPELL_DESTROY_FIELD_RUNE);
	registerEnum(SPELL_CURE_POISON_RUNE);
	registerEnum(SPELL_POISON_WALL_RUNE);
	registerEnum(SPELL_ENERGY_WALL_RUNE);
	registerEnum(SPELL_SALVATION);
	registerEnum(SPELL_CREATURE_ILLUSION);
	registerEnum(SPELL_STRONG_HASTE);
	registerEnum(SPELL_FOOD);
	registerEnum(SPELL_STRONG_ICE_WAVE);
	registerEnum(SPELL_MAGIC_SHIELD);
	registerEnum(SPELL_INVISIBLE);
	registerEnum(SPELL_CONJURE_EXPLOSIVE_ARROW);
	registerEnum(SPELL_SOUL_FIRE_RUNE);
	registerEnum(SPELL_CONJURE_ARROW);
	registerEnum(SPELL_PARALYSE_RUNE);
	registerEnum(SPELL_ENERGY_BOMB_RUNE);
	registerEnum(SPELL_WRATH_OF_NATURE);
	registerEnum(SPELL_STRONG_ETHEREAL_SPEAR);
	registerEnum(SPELL_FRONT_SWEEP);
	registerEnum(SPELL_BRUTAL_STRIKE);
	registerEnum(SPELL_ANNIHILATION);
	registerEnum(SPELL_INVITE_GUESTS);
	registerEnum(SPELL_INVITE_SUBOWNERS);
	registerEnum(SPELL_KICK_GUEST);
	registerEnum(SPELL_EDIT_DOOR);
	registerEnum(SPELL_ULTIMATE_LIGHT);
	registerEnum(SPELL_MAGIC_ROPE);
	registerEnum(SPELL_STALAGMITE_RUNE);
	registerEnum(SPELL_DISINTEGRATE_RUNE);
	registerEnum(SPELL_BERSERK);
	registerEnum(SPELL_LEVITATE);
	registerEnum(SPELL_MASS_HEALING);
	registerEnum(SPELL_ANIMATE_DEAD_RUNE);
	registerEnum(SPELL_HEAL_FRIEND);
	registerEnum(SPELL_UNDEAD_LEGION);
	registerEnum(SPELL_MAGIC_WALL_RUNE);
	registerEnum(SPELL_DEATH_STRIKE);
	registerEnum(SPELL_ENERGY_STRIKE);
	registerEnum(SPELL_FLAME_STRIKE);
	registerEnum(SPELL_CANCEL_INVISIBILITY);
	registerEnum(SPELL_POISON_BOMB_RUNE);
	registerEnum(SPELL_CONJURE_WAND_OF_DARKNESS);
	registerEnum(SPELL_CHALLENGE);
	registerEnum(SPELL_WILD_GROWTH_RUNE);
	registerEnum(SPELL_FIERCE_BERSERK);
	registerEnum(SPELL_GROUNDSHAKER);
	registerEnum(SPELL_WHIRLWIND_THROW);
	registerEnum(SPELL_ENCHANT_SPEAR);
	registerEnum(SPELL_ETHEREAL_SPEAR);
	registerEnum(SPELL_ICE_STRIKE);
	registerEnum(SPELL_TERRA_STRIKE);
	registerEnum(SPELL_ICICLE_RUNE);
	registerEnum(SPELL_AVALANCHE_RUNE);
	registerEnum(SPELL_STONE_SHOWER_RUNE);
	registerEnum(SPELL_THUNDERSTORM_RUNE);
	registerEnum(SPELL_ETERNAL_WINTER);
	registerEnum(SPELL_RAGE_OF_THE_SKIES);
	registerEnum(SPELL_TERRA_WAVE);
	registerEnum(SPELL_ICE_WAVE);
	registerEnum(SPELL_DIVINE_MISSILE);
	registerEnum(SPELL_WOUND_CLEANSING);
	registerEnum(SPELL_DIVINE_CALDERA);
	registerEnum(SPELL_DIVINE_HEALING);
	registerEnum(SPELL_TRAIN_PARTY);
	registerEnum(SPELL_PROTECT_PARTY);
	registerEnum(SPELL_HEAL_PARTY);
	registerEnum(SPELL_ENCHANT_PARTY);
	registerEnum(SPELL_HOLY_MISSILE_RUNE);
	registerEnum(SPELL_CHARGE);
	registerEnum(SPELL_PROTECTOR);
	registerEnum(SPELL_BLOOD_RAGE);
	registerEnum(SPELL_SWIFT_FOOT);
	registerEnum(SPELL_SHARPSHOOTER);
	registerEnum(SPELL_IGNITE);
	registerEnum(SPELL_CURSE);
	registerEnum(SPELL_ELECTRIFY);
	registerEnum(SPELL_INFLICT_WOUND);
	registerEnum(SPELL_ENVENOM);
	registerEnum(SPELL_HOLY_FLASH);
	registerEnum(SPELL_CURE_BLEEDING);
	registerEnum(SPELL_CURE_BURNING);
	registerEnum(SPELL_CURE_ELECTRIFICATION);
	registerEnum(SPELL_CURE_CURSE);
	registerEnum(SPELL_PHYSICAL_STRIKE);
	registerEnum(SPELL_LIGHTNING);
	registerEnum(SPELL_STRONG_FLAME_STRIKE);
	registerEnum(SPELL_STRONG_ENERGY_STRIKE);
	registerEnum(SPELL_STRONG_ICE_STRIKE);
	registerEnum(SPELL_STRONG_TERRA_STRIKE);
	registerEnum(SPELL_ULTIMATE_FLAME_STRIKE);
	registerEnum(SPELL_ULTIMATE_ENERGY_STRIKE);
	registerEnum(SPELL_ULTIMATE_ICE_STRIKE);
	registerEnum(SPELL_ULTIMATE_TERRA_STRIKE);
	registerEnum(SPELL_INTENSE_WOUND_CLEANSING);
	registerEnum(SPELL_RECOVERY);
	registerEnum(SPELL_INTENSE_RECOVERY);
	registerEnum(SPELL_PRACTISE_HEALING);
	registerEnum(SPELL_PRACTISE_FIRE_WAVE);
	registerEnum(SPELL_PRACTISE_MAGIC_MISSILE_RUNE);
	registerEnum(SPELL_APPRENT_ICES_STRIKE);
	registerEnum(SPELL_MUD_ATTACK);
	registerEnum(SPELL_CHILL_OUT);
	registerEnum(SPELL_MAGIC_PATCH);
	registerEnum(SPELL_BRUISE_BANE);
	registerEnum(SPELL_ARROW_CALL);
	registerEnum(SPELL_BUZZ);
	registerEnum(SPELL_SCORCH);
	registerEnum(SPELL_LIGHTEST_MISSILE_RUNE);
	registerEnum(SPELL_LIGHT_STONE_SHOWER_RUNE);
	registerEnum(SPELL_SUMMON_KNIGHT_FAMILIAR);
	registerEnum(SPELL_SUMMON_PALADIN_FAMILIAR);
	registerEnum(SPELL_SUMMON_SORCERER_FAMILIAR);
	registerEnum(SPELL_SUMMON_DRUID_FAMILIAR);
	registerEnum(SPELL_CHIVALROUS_CHALLENGE);
	registerEnum(SPELL_DIVINE_DAZZLE);
	registerEnum(SPELL_FAIR_WOUND_CLEANSING);
	registerEnum(SPELL_GREAT_FIRE_WAVE);
	registerEnum(SPELL_RESTORATION);
	registerEnum(SPELL_NATURES_EMBRACE);
	registerEnum(SPELL_EXPOSE_WEAKNESS);
	registerEnum(SPELL_SAP_STRENGTH);
	registerEnum(SPELL_CANCEL_MAGIC_SHIELD);
	registerEnum(MONSTER_SPELL_SINGLE_TARGET_FIRE);
	registerEnum(MONSTER_SPELL_SINGLE_TARGET_ENERGY);
	registerEnum(MONSTER_SPELL_SINGLE_TARGET_EARTH);
	registerEnum(MONSTER_SPELL_SINGLE_TARGET_ICE);
	registerEnum(MONSTER_SPELL_SINGLE_TARGET_DEATH);
	registerEnum(MONSTER_SPELL_SINGLE_TARGET_HOLY);
	registerEnum(MONSTER_SPELL_SINGLE_TARGET_HIT);
	registerEnum(MONSTER_SPELL_SINGLE_TARGET_LIFEDRAIN);
	registerEnum(MONSTER_SPELL_SINGLE_TARGET_MANADRAIN);
	registerEnum(MONSTER_SPELL_SINGLE_TARGET_DROWNING);
	registerEnum(MONSTER_SPELL_SINGLE_TARGET_BLEEDING);
	registerEnum(MONSTER_SPELL_SINGLE_TARGET_HEALING);
	registerEnum(MONSTER_SPELL_SMALL_AREA_FIRE);
	registerEnum(MONSTER_SPELL_SMALL_AREA_ENERGY);
	registerEnum(MONSTER_SPELL_SMALL_AREA_EARTH);
	registerEnum(MONSTER_SPELL_SMALL_AREA_ICE);
	registerEnum(MONSTER_SPELL_SMALL_AREA_DEATH);
	registerEnum(MONSTER_SPELL_SMALL_AREA_HOLY);
	registerEnum(MONSTER_SPELL_SMALL_AREA_HIT);
	registerEnum(MONSTER_SPELL_SMALL_AREA_LIFEDRAIN);
	registerEnum(MONSTER_SPELL_SMALL_AREA_MANADRAIN);
	registerEnum(MONSTER_SPELL_SMALL_AREA_DROWNING);
	registerEnum(MONSTER_SPELL_SMALL_AREA_BLEEDING);
	registerEnum(MONSTER_SPELL_SMALL_AREA_HEALING);
	registerEnum(MONSTER_SPELL_LARGE_AREA_FIRE);
	registerEnum(MONSTER_SPELL_LARGE_AREA_ENERGY);
	registerEnum(MONSTER_SPELL_LARGE_AREA_EARTH);
	registerEnum(MONSTER_SPELL_LARGE_AREA_ICE);
	registerEnum(MONSTER_SPELL_LARGE_AREA_DEATH);
	registerEnum(MONSTER_SPELL_LARGE_AREA_HOLY);
	registerEnum(MONSTER_SPELL_LARGE_AREA_HIT);
	registerEnum(MONSTER_SPELL_LARGE_AREA_LIFEDRAIN);
	registerEnum(MONSTER_SPELL_LARGE_AREA_MANADRAIN);
	registerEnum(MONSTER_SPELL_LARGE_AREA_DROWNING);
	registerEnum(MONSTER_SPELL_LARGE_AREA_BLEEDING);
	registerEnum(MONSTER_SPELL_LARGE_AREA_HEALING);
	registerEnum(MONSTER_SPELL_WAVE_FIRE);
	registerEnum(MONSTER_SPELL_WAVE_ENERGY);
	registerEnum(MONSTER_SPELL_WAVE_EARTH);
	registerEnum(MONSTER_SPELL_WAVE_ICE);
	registerEnum(MONSTER_SPELL_WAVE_DEATH);
	registerEnum(MONSTER_SPELL_WAVE_HOLY);
	registerEnum(MONSTER_SPELL_WAVE_HIT);
	registerEnum(MONSTER_SPELL_WAVE_LIFEDRAIN);
	registerEnum(MONSTER_SPELL_WAVE_MANADRAIN);
	registerEnum(MONSTER_SPELL_WAVE_DROWNING);
	registerEnum(MONSTER_SPELL_WAVE_BLEEDING);
	registerEnum(MONSTER_SPELL_WAVE_HEALING);
	registerEnum(MONSTER_SPELL_DELETEFIELD);
	registerEnum(MONSTER_SPELL_CHALLENGE);
	registerEnum(MONSTER_SPELL_SPEED);
	registerEnum(MONSTER_SPELL_DRUNKEN);
	registerEnum(MONSTER_SPELL_STRENGTH);
	registerEnum(MONSTER_SPELL_OUTFIT);
	registerEnum(MONSTER_SPELL_SUMMON);
	registerEnum(MONSTER_SPELL_MAGICLEVEL);
	registerEnum(MONSTER_SPELL_TELEPORT);
	registerEnum(MONSTER_SPELL_HEX);
	registerEnum(MONSTER_SPELL_SUPER_DRUNKEN);
	registerEnum(MONSTER_SPELL_ROOT);
	registerEnum(MONSTER_SPELL_FEAR);
	registerEnum(MONSTER_SPELL_HIGHRISK_TELEPORT);
	registerEnum(MONSTER_SPELL_MINION);
	registerEnum(MONSTER_SPELL_AGONY);
	registerEnum(AMPHIBIC_BARK);
	registerEnum(AQUATIC_BEAST_BARK);
	registerEnum(AQUATIC_CRITTER_BARK);
	registerEnum(AQUATIC_DEEPLING_BARK);
	registerEnum(AQUATIC_QUARA_BARK);
	registerEnum(BIRD_BARK);
	registerEnum(CONSTRUCT_BARK);
	registerEnum(DEMON_BARK);
	registerEnum(DRAGON_BARK);
	registerEnum(ELEMENTAL_EARTH_BARK);
	registerEnum(ELEMENTAL_ENERGY_BARK);
	registerEnum(ELEMENTAL_FIRE_BARK);
	registerEnum(ELEMENTAL_WATER_BARK);
	registerEnum(EXTRA_DIMENSIONAL_BEAST_BARK);
	registerEnum(EXTRA_DIMENSIONAL_ENERGY_BARK);
	registerEnum(EXTRA_DIMENSIONAL_HORROR_BARK);
	registerEnum(FEY_BARK);
	registerEnum(GIANT_BARK);
	registerEnum(HUMAN_FEMALE_BARK);
	registerEnum(HUMAN_MALE_BARK);
	registerEnum(HUMANOID_GOBLIN_BARK);
	registerEnum(HUMANOID_ORC_BARK);
	registerEnum(LYCANTHROPE_BARK);
	registerEnum(MAGICAL_ENERGY_BARK);
	registerEnum(MAGICAL_HORROR_BARK);
	registerEnum(MAMMAL_BEAR_BARK);
	registerEnum(MAMMAL_CRITTER_BARK);
	registerEnum(MAMMAL_DOG_BARK);
	registerEnum(MAMMAL_ELEPHANT_BARK);
	registerEnum(MAMMAL_FERAL_BARK);
	registerEnum(MAMMAL_HORSE_BARK);
	registerEnum(MAMMAL_MAMMOTH_BARK);
	registerEnum(MONSTER_BARK);
	registerEnum(PHANTOM_BARK);
	registerEnum(PLANT_BARK);
	registerEnum(REPTILE_LARGE_BARK);
	registerEnum(REPTILE_SMALL_BARK);
	registerEnum(SLIME_BARK);
	registerEnum(UNDEAD_BARK);
	registerEnum(VERMIN_CRITTER_BARK);
	registerEnum(VERMIN_INSECT_BARK);
	registerEnum(VERMIN_ROTWORM_BARK);
	registerEnum(HUMAN_SAGE_BARK);
	registerEnum(HUMAN_CRONE_BARK);
	registerEnum(APE_BARK);
	registerEnum(AMPHIBIC_DEATH);
	registerEnum(AQUATIC_BEAST_DEATH);
	registerEnum(AQUATIC_CRITTER_DEATH);
	registerEnum(AQUATIC_DEEPLING_DEATH);
	registerEnum(AQUATIC_QUARA_DEATH);
	registerEnum(BIRD_DEATH);
	registerEnum(CONSTRUCT_DEATH);
	registerEnum(DEMON_DEATH);
	registerEnum(DRAGON_DEATH);
	registerEnum(ELEMENTAL_EARTH_DEATH);
	registerEnum(ELEMENTAL_ENERGY_DEATH);
	registerEnum(ELEMENTAL_FIRE_DEATH);
	registerEnum(ELEMENTAL_WATER_DEATH);
	registerEnum(EXTRA_DIMENSIONAL_BEAST_DEATH);
	registerEnum(EXTRA_DIMENSIONAL_ENERGY_DEATH);
	registerEnum(EXTRA_DIMENSIONAL_HORROR_DEATH);
	registerEnum(FEY_DEATH);
	registerEnum(GIANT_DEATH);
	registerEnum(HUMAN_FEMALE_DEATH);
	registerEnum(HUMAN_MALE_DEATH);
	registerEnum(HUMANOID_GOBLIN_DEATH);
	registerEnum(HUMANOID_ORC_DEATH);
	registerEnum(LYCANTHROPE_DEATH);
	registerEnum(MAGICAL_ENERGY_DEATH);
	registerEnum(MAGICAL_HORROR_DEATH);
	registerEnum(MAMMAL_BEAR_DEATH);
	registerEnum(MAMMAL_CRITTER_DEATH);
	registerEnum(MAMMAL_DOG_DEATH);
	registerEnum(MAMMAL_ELEPHANT_DEATH);
	registerEnum(MAMMAL_FERAL_DEATH);
	registerEnum(MAMMAL_HORSE_DEATH);
	registerEnum(MAMMAL_MAMMOTH_DEATH);
	registerEnum(MONSTER_DEATH);
	registerEnum(PHANTOM_DEATH);
	registerEnum(PLANT_DEATH);
	registerEnum(REPTILE_LARGE_DEATH);
	registerEnum(REPTILE_SMALL_DEATH);
	registerEnum(SLIME_DEATH);
	registerEnum(UNDEAD_DEATH);
	registerEnum(VERMIN_CRITTER_DEATH);
	registerEnum(VERMIN_INSECT_DEATH);
	registerEnum(VERMIN_ROTWORM_DEATH);
	registerEnum(HUMAN_SAGE_DEATH);
	registerEnum(HUMAN_CRONE_DEATH);
	registerEnum(APE_DEATH);
	registerEnum(UNKNOWN_CREATURE_DEATH_1);
	registerEnum(UNKNOWN_CREATURE_DEATH_2);
	registerEnum(UNKNOWN_CREATURE_DEATH_3);
	registerEnum(UNKNOWN_CREATURE_DEATH_4);
	registerEnum(ACTION_HEAVY_METAL_LOUD);
	registerEnum(ENV_INSECTS_BIRDS);
	registerEnum(ENV_WIND_1);
	registerEnum(ENV_WIND_CLOSE);
	registerEnum(ENV_WATER_DEPTH_BOAT_SURFACE);
	registerEnum(ENV_METALIC_SPACE);
	registerEnum(ENV_FROGS_INSECTS_WOODS);
	registerEnum(ENV_WATER_DEPTH);
	registerEnum(ENV_SEA_WAVE);
	registerEnum(ENV_WIND_2);
	registerEnum(ENV_WIND_3);
	registerEnum(ENV_MONKEYS);
	registerEnum(ENV_STORM_COMING);
	registerEnum(ACTION_HITTING_WOOD);
	registerEnum(ENV_WOOD_STICK_SMASH);
	registerEnum(ENV_THICK_BLOB_LIQUID_1);
	registerEnum(ENV_LITTLE_BIRTS_FLOREST);
	registerEnum(ENV_THICK_BLOCK_LIQUID_CLOSE);
	registerEnum(ACTION_METAL_CHAINS_MOVING);
	registerEnum(ENV_CRICKET_1);
	registerEnum(ENV_CRICKET_2);
	registerEnum(ENV_CRICKET_3);
	registerEnum(ENV_CICADA_1);
	registerEnum(ENV_STONES_FALLING);
	registerEnum(ACTION_OPEN_DOOR);
	registerEnum(ACTION_CLOSE_DOOR);
	registerEnum(ENV_OWL);
	registerEnum(ENV_ELETRONIC_DEVICE);
	registerEnum(ENV_REPTILE_NOISE);
	registerEnum(ENV_FORGE_METAL_1);
	registerEnum(ENV_FROG);
	registerEnum(ACTION_WOOD_OBJECT_USING);
	registerEnum(ACTION_METAL_OBJECT_HIT);
	registerEnum(ACTION_NAIL_HIT);
	registerEnum(ENV_BELL_RING);
	registerEnum(ENV_HOT_METAL_ON_WATER);
	registerEnum(ENV_WATER_SMOKE);
	registerEnum(ENV_WOLF_HOWL);
	registerEnum(ENV_WOOD_CRACKLE_CLOSE);
	registerEnum(ENV_LAUGHT);
	registerEnum(ENV_WIND_MOVING_LEAF);
	registerEnum(ENV_WIND_MOVING_FEW_LEAF);
	registerEnum(ACTION_PORTAL_CAST);
	registerEnum(ACTION_FIRE_MAGIC_CAST);
	registerEnum(ENV_TRAPDOOR_OPEN);
	registerEnum(ENV_NAIL_FALLING);
	registerEnum(ENV_LIGHT_BLOB_LIQUID);
	registerEnum(ENV_LION_ROAR);
	registerEnum(ENV_MOVING_OBJECT_BUTTON_TRIGGER);
	registerEnum(ENV_SNAKE_1);
	registerEnum(ENV_HUMAN_SCREEN_1);
	registerEnum(ENV_HUMAN_SCREEN_2);
	registerEnum(ENV_SEAGUL_1);
	registerEnum(ENV_FAST_FOOTSTEPS);
	registerEnum(ENV_SLOW_FOOTSTEPS);
	registerEnum(ENV_THICK_BLOB_LIQUID_2);
	registerEnum(ENV_MOVING_LEAF);
	registerEnum(ENV_WOOD_CRACKLE_1);
	registerEnum(ACTION_OBJECT_FALLING_DEPTH);
	registerEnum(ACTION_BUTTON_TRIGGER);
	registerEnum(ENV_HEAVEN_DARK_REVERB);
	registerEnum(ENV_WIND_4);
	registerEnum(ENV_INSECT_1);
	registerEnum(ENV_FLUTE_SONG);
	registerEnum(ENV_INSECTS_BIRDS_DEATH);
	registerEnum(ENV_INSECT_CREATURE_DEATH);
	registerEnum(ENV_LOW_ROAR);
	registerEnum(ENV_SINISTER_BURPH);
	registerEnum(ENV_CROWD_SCREEN);
	registerEnum(ENV_BIRDS_FLYING);
	registerEnum(ENV_CROWD_VOICES_1);
	registerEnum(ENV_BIRD_CUCO);
	registerEnum(ENV_RAVINE);
	registerEnum(ENV_RAVINE_METALIC);
	registerEnum(ENV_STICKS_LEAF_STEP);
	registerEnum(ACTION_DISPEL_MAGIC_1);
	registerEnum(ACTION_DISPEL_MAGIC_2);
	registerEnum(ENV_CROWD_VOICES_2);
	registerEnum(ENV_CROWD_VOICES_3);
	registerEnum(ENV_CROWD_VOICES_4);
	registerEnum(ACTION_METAL_OBJECT_FALL);
	registerEnum(ENV_HOURSE_STEPS);
	registerEnum(ENV_DRUMES_SINISTER_REVERB);
	registerEnum(ACTION_WOOD_PIECES_FALL);
	registerEnum(ACTION_KNIFE_CUT_FLESH);
	registerEnum(ENV_CROWD_VOICES_5);
	registerEnum(ENV_CICADA_2);
	registerEnum(ENV_FLYES);
	registerEnum(ENV_NOISE_WATER);
	registerEnum(ENV_PIG_SOUND_1);
	registerEnum(ENV_PIG_SOUND_2);
	registerEnum(ENV_SHEEP_SOUND_1);
	registerEnum(ENV_SHEEP_SOUND_2);
	registerEnum(ENV_FIRE);
	registerEnum(ENV_NOISE_SNOW);
	registerEnum(ENV_FIRE_PLACE);
	registerEnum(ENV_WATERFALL);
	registerEnum(ENV_WATER_SOURCE);
	registerEnum(ACTION_HAMMER_HITING_NAILS_1);
	registerEnum(ACTION_HAMMER_HITING_NAILS_2);
	registerEnum(ENV_QUICK_STEPS);
	registerEnum(ENV_HEAVY_OBJECT_FALL);
	registerEnum(ACTION_HITING_FORGE);
	registerEnum(ENV_WOOD_CRACKLE_2);
	registerEnum(ACTION_WOOD_HIT);
	registerEnum(MUSIC_CUT_BIRDS);
	registerEnum(MUSIC_CUT_LITTLE_BIRDS);
	registerEnum(MUSIC_CUT_INSECTS_1);
	registerEnum(MUSIC_CUT_INSECTS_2);
	registerEnum(MUSIC_CUT_INSECTS_3);
	registerEnum(MUSIC_CUT_FLUTE_WEST);
	registerEnum(MUSIC_CUT_CROWS_VOICES);
	registerEnum(MUSIC_CUT_WIND_WATER);
	registerEnum(MUSIC_CUT_THICK_BLOCK_DEPTH);
	registerEnum(ENV_CAMEL);
	registerEnum(UNKNOWN_CREATURE_DEATH_5);
	registerEnum(ENV_CHICKEN_1);
	registerEnum(ENV_CHICKEN_2);
	registerEnum(ENV_THRILLER_METALLIC);
	registerEnum(ACTION_NOTIFICATION);
	registerEnum(ACTION_LEVEL_ACHIEVEMENT);
	registerEnum(ACTION_SCREENSHOT);
	registerEnum(ACTION_CLICK_ON);
	registerEnum(ACTION_CLICK_OFF);
	registerEnum(ACTION_DRUMS);
	registerEnum(ACTION_XYLOPHONE_SLOW_DRUM);
	registerEnum(ACTION_HARP_1);
	registerEnum(ACTION_HARP_2);
	registerEnum(ACTION_MOVING_WOOD);
	registerEnum(ACTION_CRATE_BREAK_MAGIC_DUST);
	registerEnum(ACTION_BELL_RING);
	registerEnum(ACTION_SELECT_OBJECT);
	registerEnum(ITEM_MOVE_BACKPACK);
	registerEnum(ITEM_USE_POTION);
	registerEnum(ITEM_MOVE_NECKLACES);
	registerEnum(ITEM_MOVE_ARMORS);
	registerEnum(ITEM_MOVE_METALIC);
	registerEnum(ITEM_MOVE_DISTANCE);
	registerEnum(ITEM_MOVE_WOOD);
	registerEnum(ITEM_MOVE_STACKABLE);
	registerEnum(ITEM_MOVE_DEFAULT);
	registerEnum(ITEM_MOVE_LEGS);
	registerEnum(ITEM_MOVE_HELMETS);
	registerEnum(ITEM_MOVE_QUIVERS);
	registerEnum(ITEM_MOVE_RINGS);
	registerEnum(ENV_FROG_OR_LIQUID);
	registerEnum(ACTION_WOOD_OBJECT_HIT_STORE);
	registerEnum(ITEM_MOVE_BOOTS);
	registerEnum(ACTION_SWORD_DRAWN);
	registerEnum(ACTION_EAT);
	registerEnum(ACTION_STORE_BIG_OBJECT);
	registerEnum(ACTION_STORE_WOOD_OBJECT);
	registerEnum(ACTION_VIP_LOGOUT);
	registerEnum(ACTION_VIP_LOGIN);
	registerEnum(ENV_CAT_1);
	registerEnum(ENV_INSECT_2);
	registerEnum(ENV_SEAGUL_2);
	registerEnum(ENV_LIQUID_SPILL);
	registerEnum(ENV_COW_MOO_1);
	registerEnum(ENV_COW_MOO_2);
	registerEnum(ENV_CAT_2);
	registerEnum(ACTION_REAWRD_FEY);
	registerEnum(ACTION_REWARD_GUITAR_1);
	registerEnum(ACTION_REWARD_GUITAR_2);
	registerEnum(ENV_WOODS_WATER_SOURCE);
	registerEnum(ENV_HYENA);
	registerEnum(UNKNOWN_CREATURE_DEATH_6);
	registerEnum(ENV_COW_MOO_3);
	registerEnum(UNKNOWN_CREATURE_DEATH_7);
	registerEnum(ENV_METALIC_SPACE_ALIEN);
	registerEnum(ACTION_AIR_STRIKE);
	registerEnum(ENV_WATER);
	registerEnum(ENV_SNAKE_2);
	registerEnum(GOD_SPELL_KILL_ALL_MONSTERS);
