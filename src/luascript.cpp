...
const std::unordered_map<std::string, CombatType_t> AbilitieAbsorbPercentMap = {
	...
	{"absorbpercentundefined", COMBAT_UNDEFINEDDAMAGE},
...
const std::unordered_map<std::string, CombatType_t> AbilitieFieldAbsorbPercentMap = {
	{"fieldabsorbpercentphysical", COMBAT_PHYSICALDAMAGE},
	{"fieldabsorbpercentenergy", COMBAT_ENERGYDAMAGE},
	{"fieldabsorbpercentearth", COMBAT_EARTHDAMAGE},
	{"fieldabsorbpercentfire", COMBAT_FIREDAMAGE},
	{"fieldabsorbpercentundefined", COMBAT_UNDEFINEDDAMAGE},
	{"fieldabsorbpercentlifedrain", COMBAT_LIFEDRAIN},
	{"fieldabsorbpercentmanadrain", COMBAT_MANADRAIN},
	{"fieldabsorbpercenthealing", COMBAT_HEALING},
	{"fieldabsorbpercentdrown", COMBAT_DROWNDAMAGE},
	{"fieldabsorbpercentice", COMBAT_ICEDAMAGE},
	{"fieldabsorbpercentholy", COMBAT_HOLYDAMAGE},
	{"fieldabsorbpercentdeath", COMBAT_DEATHDAMAGE},
};

const std::unordered_map<std::string, CombatType_t> AbilitieElementsMap = {
	{"elementphysical", COMBAT_PHYSICALDAMAGE},
	{"elementenergy", COMBAT_ENERGYDAMAGE},
	{"elementearth", COMBAT_EARTHDAMAGE},
	{"elementfire", COMBAT_FIREDAMAGE},
	{"elementdrown", COMBAT_DROWNDAMAGE},
...
const std::unordered_map<std::string, ConditionType_t> AbilitieConditionTypeMap = {
	{"suppressdrunk", CONDITION_DRUNK},
	{"suppressenergy", CONDITION_ENERGY},
	{"suppressfire", CONDITION_FIRE},
	{"suppresspoison", CONDITION_POISON},
	{"suppressdrown", CONDITION_DROWN},
	{"suppressphysical", CONDITION_BLEEDING},
	{"suppressfreeze", CONDITION_FREEZING},
	{"suppressdazzle", CONDITION_DAZZLED},
	{"suppresscurse", CONDITION_CURSED},
};

const std::unordered_map<std::string, SpecialSkills_t> AbilitieSpecialSkillMap = {
	{"criticalchance", SPECIALSKILL_CRITICALHITCHANCE},
	{"criticalamount", SPECIALSKILL_CRITICALHITAMOUNT},
	{"criticalhitchance", SPECIALSKILL_CRITICALHITCHANCE},
	{"criticalhitamount", SPECIALSKILL_CRITICALHITAMOUNT},
	{"lifeleechchance", SPECIALSKILL_LIFELEECHCHANCE},
	{"lifeleechamount", SPECIALSKILL_LIFELEECHAMOUNT},
	{"manaleechchance", SPECIALSKILL_MANALEECHCHANCE},
	{"manaleechamount", SPECIALSKILL_MANALEECHAMOUNT},
};
...
void LuaScriptInterface::registerFunctions()
{
	...
	registerMethod("Game", "createItemType", LuaScriptInterface::luaGameCreateItemType);
