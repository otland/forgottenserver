...
bool ConfigManager::load()
{
	...
	boolean[PLAYER_ITEMS_CACHE] = getGlobalBoolean(L, "playerItemsCache", false);
	...
	integer[PLAYER_ITEMS_CACHE_SAVE_THRESHOLD] = getGlobalNumber(L, "playerItemsCacheSaveThreshold", 5000);
