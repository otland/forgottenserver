...
bool ConfigManager::load()
{
	...
	boolean[BESTIARY_FOR_PARTY_MEMBERS] = getGlobalBoolean(L, "bestiaryForPartyMembers", false);
	...
	integer[BESTIARY_COUNT_PER_KILL] = getGlobalNumber(L, "bestiaryCountPerKill", 1);
