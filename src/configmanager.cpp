...
bool ConfigManager::load()
{
	...
	integer[OFFLINE_TRAINING_SKILL] = getGlobalNumber(L, "offlineTrainingSkill", 1);
	integer[OFFLINE_TRAINING_MAGIC] = getGlobalNumber(L, "offlineTrainingMagic", 1);
	integer[OFFLINE_TRAINING_SHIELD] = getGlobalNumber(L, "offlineTrainingShield", 1);
