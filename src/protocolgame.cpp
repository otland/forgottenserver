...
void ProtocolGame::login(const std::string& name, uint32_t accountId, OperatingSystem_t operatingSystem)
{
	...
	if (!foundPlayer || g_config.getBoolean(ConfigManager::ALLOW_CLONES)) {
		...
		if (foundPlayer->client) {
			...
			eventConnect = g_gameScheduler.addEvent(
			    createGameTask(1000, [=, thisPtr = getThis(), playerID = foundPlayer->getID()]() {
...
void ProtocolGame::onRecvFirstMessage(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, thisPtr = getThis(), characterName = std::move(characterName)]() {
...
void ProtocolGame::parsePacket(NetworkMessage& msg)
{
	...
	switch (recvbyte) {
		case 0x14:
			g_networkScheduler.addTask([thisPtr = getThis()]() { thisPtr->logout(true, false); });
			break;
		case 0x1D:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerReceivePingBack(playerID); });
			break;
		case 0x1E:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerReceivePing(playerID); });
			break;
		...
		case 0x64:
			...
			break;
		case 0x65:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerMove(playerID, DIRECTION_NORTH); });
			break;
		case 0x66:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerMove(playerID, DIRECTION_EAST); });
			break;
		case 0x67:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerMove(playerID, DIRECTION_SOUTH); });
			break;
		case 0x68:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerMove(playerID, DIRECTION_WEST); });
			break;
		case 0x69:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerStopAutoWalk(playerID); });
			break;
		case 0x6A:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerMove(playerID, DIRECTION_NORTHEAST); });
			break;
		case 0x6B:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerMove(playerID, DIRECTION_SOUTHEAST); });
			break;
		case 0x6C:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerMove(playerID, DIRECTION_SOUTHWEST); });
			break;
		case 0x6D:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerMove(playerID, DIRECTION_NORTHWEST); });
			break;
		case 0x6F:
			g_networkScheduler.addTask(NETWORKSCHEDULER_TASK_EXPIRATION,
		...
		case 0x7B:
			...
			break;
		case 0x7C:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerCloseShop(playerID); });
			break;
		case 0x7D:
		...
		case 0x7E:
			...
			break;
		case 0x7F:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerAcceptTrade(playerID); });
			break;
		case 0x80:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerCloseTrade(playerID); });
			break;
		case 0x82:
			parseUseItem(msg);
			break;
		...
		case 0x96:
			...
			break;
		case 0x97:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerRequestChannels(playerID); });
			break;
		case 0x98:
		...
		case 0x9A:
			...
			break;
		case 0x9E:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerCloseNpcChannel(playerID); });
			break;
		case 0xA0:
			parseFightModes(msg);
			break;
		...
		case 0xA6:
			...
			break;
		case 0xA7:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerLeaveParty(playerID); });
			break;
		case 0xA8:
			parseEnableSharedPartyExperience(msg);
			break;
		case 0xAA:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerCreatePrivateChannel(playerID); });
			break;
		case 0xAB:
		...
		case 0xBE:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerCancelAttackAndFollow(playerID); });
			break;
		...
		case 0xD0:
			...
			break;
		case 0xD2:
			g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerRequestOutfit(playerID); });
			break;
		case 0xD3:
			parseSetOutfit(msg);
			break;
...
void ProtocolGame::parseOpenChannel(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerOpenChannel(playerID, channelID); });
}

void ProtocolGame::parseCloseChannel(NetworkMessage& msg)
{
	uint16_t channelID = msg.get<uint16_t>();
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerCloseChannel(playerID, channelID); });
}

void ProtocolGame::parseOpenPrivateChannel(NetworkMessage& msg)
{
	std::string receiver = msg.getString();
	g_networkScheduler.addTask([playerID = player->getID(), receiver = std::move(receiver)]() {
...
void ProtocolGame::parseSetOutfit(NetworkMessage& msg)
{
	...
	if (outfitType == 0) {
		...
		// apply to podium
		g_networkScheduler.addTask(NETWORKSCHEDULER_TASK_EXPIRATION, [=, playerID = player->getID()]() {
...
void ProtocolGame::parseToggleMount(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerToggleMount(playerID, mount); });
}
...
void ProtocolGame::parseCloseContainer(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerCloseContainer(playerID, cid); });
}

void ProtocolGame::parseUpArrowContainer(NetworkMessage& msg)
{
	uint8_t cid = msg.getByte();
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerMoveUpContainer(playerID, cid); });
}

void ProtocolGame::parseUpdateContainer(NetworkMessage& msg)
{
	uint8_t cid = msg.getByte();
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerUpdateContainer(playerID, cid); });
}
...
void ProtocolGame::parseSay(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, playerID = player->getID(), receiver = std::move(receiver), text = std::move(text)]() {
...
void ProtocolGame::parseFightModes(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, playerID = player->getID()]() {
...
void ProtocolGame::parseAttack(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerSetAttackedCreature(playerID, creatureID); });
}
...
void ProtocolGame::parseFollow(NetworkMessage& msg)
{
	uint32_t creatureID = msg.get<uint32_t>();
	// msg.get<uint32_t>(); creatureID (same as above)
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerFollowCreature(playerID, creatureID); });
}
...
void ProtocolGame::parseTextWindow(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([playerID = player->getID(), windowTextID, newText = std::move(newText)]() {
...
void ProtocolGame::parseRemoveVip(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerRequestRemoveVip(playerID, guid); });
}
...
void ProtocolGame::parseEditVip(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, playerID = player->getID(), description = std::move(description)]() {
...
void ProtocolGame::parseRuleViolationReport(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, playerID = player->getID(), targetName = std::move(targetName),
...
void ProtocolGame::parseBugReport(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, playerID = player->getID(), message = std::move(message)]() {
...
void ProtocolGame::parseDebugAssert(NetworkMessage& msg)
{
	...
	std::string description = msg.getString();
	std::string comment = msg.getString();
	g_networkScheduler.addTask([playerID = player->getID(), assertLine = std::move(assertLine), date = std::move(date),
...
void ProtocolGame::parseInviteToParty(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerInviteToParty(playerID, targetID); });
}

void ProtocolGame::parseJoinParty(NetworkMessage& msg)
{
	uint32_t targetID = msg.get<uint32_t>();
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerJoinParty(playerID, targetID); });
}

void ProtocolGame::parseRevokePartyInvite(NetworkMessage& msg)
{
	uint32_t targetID = msg.get<uint32_t>();
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerRevokePartyInvitation(playerID, targetID); });
}

void ProtocolGame::parsePassPartyLeadership(NetworkMessage& msg)
{
	uint32_t targetID = msg.get<uint32_t>();
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerPassPartyLeadership(playerID, targetID); });
}
...
void ProtocolGame::parseQuestLine(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerShowQuestLine(playerID, questID); });
}
...
void ProtocolGame::parseQuestTracker(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([playerID = player->getID(), missionIDs = std::move(missionIDs)]() {
...
{
	g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerLeaveMarket(playerID); });
}
...
void ProtocolGame::parseMarketBrowse(NetworkMessage& msg)
{
	...
	if (browseId == MARKETREQUEST_OWN_OFFERS) {
		g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerBrowseMarketOwnOffers(playerID); });
	} else if (browseId == MARKETREQUEST_OWN_HISTORY) {
		g_networkScheduler.addTask([playerID = player->getID()]() { g_game.playerBrowseMarketOwnHistory(playerID); });
	} else {
		uint16_t spriteID = msg.get<uint16_t>();
		g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerBrowseMarket(playerID, spriteID); });
	}
}
...
{
	Position pos = msg.getPosition();
	g_networkScheduler.addTask([=, playerID = player->getID()]() { g_game.playerBrowseField(playerID, pos); });
}
...
void ProtocolGame::parseExtendedOpcode(NetworkMessage& msg)
{
	...
	g_networkScheduler.addTask([=, playerID = player->getID(), buffer = std::move(buffer)]() {
