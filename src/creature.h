...
public:
	...
	Creature* getCreature() final { return this; }
	const Creature* getCreature() const final { return this; }
	...
	int32_t getThrowRange() const final { return 1; }
	bool isPushable() const override { return getWalkDelay() <= 0; }
	bool isRemoved() const final { return isInternalRemoved; }
	...
	virtual uint32_t getMaxMana() const { return 0; }
	...
	virtual void onUpdateTileItem(const Tile* tile, const Position& pos, const Item* oldItem, const ItemType& oldType, const Item* newItem,
	...
	Cylinder* getParent() const final { return tile; }
	...
	const Position& getPosition() const final { return position; }

	Tile* getTile() final { return tile; }
	const Tile* getTile() const final { return tile; }
	...
	bool getPathTo(const Position& targetPos, std::forward_list<Direction>& dirList, int32_t minTargetDist, int32_t maxTargetDist, bool fullPathSearch = true,
...
protected:
	...
	// creature script events
	bool hasEventRegistered(CreatureEventType_t event) const { return (0 != (scriptEventsBitField & (static_cast<uint32_t>(1) << event))); }
