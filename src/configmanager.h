...
class ConfigManager
{
	public:
		...
		enum integer_config_t {
			...
			CHECK_EXPIRED_MARKET_OFFERS_EACH_MINUTES = 31,
			MAX_MARKET_OFFERS_AT_A_TIME_PER_PLAYER = 32,
			EXP_FROM_PLAYERS_LEVEL_RANGE = 33,
			MAX_PACKETS_PER_SECOND = 34,
