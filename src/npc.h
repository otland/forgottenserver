...
public:
	...
	Npc* getNpc() final { return this; }
	const Npc* getNpc() const final { return this; }

	bool isPushable() const final { return walkTicks > 0; }
	...
	CreatureType_t getType() const final { return CREATURETYPE_NPC; }

	uint8_t getSpeechBubble() const final { return speechBubble; }
...
protected:
	...
	bool isImmune(CombatType_t) const final { return !attackable; }
	bool isImmune(ConditionType_t) const final { return !attackable; }
	bool isAttackable() const final { return attackable; }
