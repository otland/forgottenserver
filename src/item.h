...
enum AbilityTypes_t {
	...
	ABILITY_CRITICALHITCHANCE = 20,
	ABILITY_CRITICALHITAMOUNT = 21,
	ABILITY_LIFELEECHCHANCE = 22,
	ABILITY_LIFELEECHAMOUNT = 23,
	ABILITY_MANALEECHCHANCE = 24,
	ABILITY_MANALEECHAMOUNT = 25,
	ABILITY_SPEED = 26,
	ABILITY_ABSORBPHYSICAL = 27,
	ABILITY_ABSORBENERGY = 28,
	ABILITY_ABSORBEARTH = 29,
	ABILITY_ABSORBFIRE = 30,
	ABILITY_ABSORBWATER = 31,
	ABILITY_ABSORBICE = 32,
	ABILITY_ABSORBHOLY = 33,
	ABILITY_ABSORBDEATH = 34,
	ABILITY_FIELDABSORBPHYSICAL = 35,
	ABILITY_FIELDABSORBENERGY = 36,
	ABILITY_FIELDABSORBEARTH = 37,
	ABILITY_FIELDABSORBFIRE = 38,
	ABILITY_FIELDABSORBWATER = 39,
	ABILITY_FIELDABSORBICE = 40,
	ABILITY_FIELDABSORBHOLY = 41,
	ABILITY_FIELDABSORBDEATH = 42,
	ABILITY_ELEMENTTYPE = 43,
	ABILITY_ELEMENTDAMAGE = 44,
	ABILITY_MANASHIELD = 45,
	ABILITY_INVISIBLE = 46,
	ABILITY_REGENERATION = 47,
