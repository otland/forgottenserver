...
enum MagicEffectClasses {
	...
	CONST_ME_ORCSHAMAN			= 0x46, //70
	CONST_ME_ORCSHAMAN_FIRE		= 0x47, //71
	CONST_ME_THUNDER			= 0x48, //72
	CONST_ME_FERUMBRAS			= 0x49, //73
	CONST_ME_CONFETTI_HORIZONTAL	= 0x4A, //74
	CONST_ME_CONFETTI_VERTICAL 	= 0x4B, //75
	// 76-156 are empty
	CONST_ME_BLACKSMOKE		= 0x9D, //157
