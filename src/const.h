...
enum MessageClasses : uint8_t {
	MESSAGE_STATUS_CONSOLE_BLUE		= 0x04, /*Blue message in the console*/
	...
	MESSAGE_LOOT					= 0x1F, /*Green message in game window and in the console*/
	MESSAGE_TRADE_NPC				= 0x20, /*Green message in game window and in the console*/
	MESSAGE_EVENT_GUILD				= 0x21, /*Green message in game window and in the console*/
	MESSAGE_PARTY_MANAGEMENT		= 0x22, /*Green message in game window and in the console*/
	MESSAGE_PARTY					= 0x23, /*Green message in game window and in the console*/
	MESSAGE_EVENT_ORANGE			= 0x24, /*Orange message in the console*/
	MESSAGE_STATUS_CONSOLE_ORANGE	= 0x25, /*Orange message in the console*/
	MESSAGE_REPORT					= 0x26, /*White message in game window and in the console*/
	MESSAGE_HOTKEY_USE				= 0x27, /*Green message in game window*/
