...
### Issues [![Open Source Helpers](https://www.codetriage.com/otland/forgottenserver/badges/users.svg)](https://www.codetriage.com/otland/forgottenserver)

We use the [issue tracker on GitHub](https://github.com/otland/forgottenserver/issues). Keep in mind that everyone who is watching the repository gets notified by e-mail when there is activity, so be thoughtful and avoid writing comments that aren't meaningful for an issue (e.g. "+1"). If you'd like for an issue to be fixed faster, you should either fix it yourself and submit a pull request, or place a bounty on the issue.

In addition to posting issues, you can help to triage them. This can include reproducing bug reports, or asking for vital information such as version numbers or reproduction instructions. If you would like to start triaging issues, one easy way to get started is to [subscribe to forgottenserver on CodeTriage](https://www.codetriage.com/otland/forgottenserver).
